---
url: /04-HashiCorp/04-Consul/06-on_Kubernetes/configuration/envoy_timeout.md
...
* 일부 기본 timeout 값은 기본값
  * static\_resources.clusters.\*.connect\_timeout : "1s"
  * dynamic\_active\_clusters.\*.connect\_timeout : "5s"
...
## 단계 5. config\_dump 재생성

* Pod 재기동 없이 dump 확인
  * dynamic\_active\_clusters.connect\_timeout : "60s"
  * type.googleapis.com/envoy.extensions.filters.network.http\_connection\_manager.v3.HttpConnectionManager route timeout : "60s"
