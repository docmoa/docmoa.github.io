---
url: /04-HashiCorp/06-Vault/04-UseCase/vault-k8s-integration-three-methods.md
---
...
| ------------------------------------------------------------ | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| Secret projection                                            |               공유 메모리 볼륨환경 변수\*               |       임시 디스크환경변수쿠버네티스 시크릿       | 쿠버네티스 시크릿쿠버네티스 시크릿 볼륨환경변수  |
...
| Secret size limit                                            | Vault w/ConsulBackend: 512 KB(기본)제한없음Vault w/Integrated StorageBackend: 1MiB(기본)제한없음 | Vault w/ConsulBackend: 512 KB(기본)제한없음Vault w/Integrated StorageBackend: 1MiB(기본)제한없음 | Vault w/ConsulBackend: 512 KB(기본)제한없음Vault w/Integrated StorageBackend: 1MiB(기본)제한없음 |
...
| Helm support                                                 |                              ✅                               |                              ✅                               |                              ✅                               |
| Custom Support                                               |                              ❌                               |                              ❌                               |                              ✅                               |
| K8s Secretsdrift detectionand automationremediation |                              ❌                               |                              ❌                               |                              ✅                               |
