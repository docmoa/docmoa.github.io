---
url: /04-HashiCorp/06-Vault/02-Secret_Engine/vault-kong-secrets.md
description: >-
  HashiCorp Vault(또는 OpenBao) secrets engine으로 Kong key-auth 자격 증명을 발급하고, 리스가
  끝나면 Kong에서 키를 삭제하는 vault-kong-secrets 소개
---
# Kong key-auth
