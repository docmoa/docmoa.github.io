---
url: /04-HashiCorp/06-Vault/02-Secret_Engine/ssh-signed-certificates.md
...
2. Vault에 생성한 키 중 공개키 (.pub)에 대한 서명 요청
   ...
   * signed\_key는 또다른 public key

   위와 같은 방식으로 생성되는 추가 public key인 signed\_key를 저장하고자 한다면 다음과 같은 방식으로 가능
