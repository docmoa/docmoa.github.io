---
url: /04-HashiCorp/06-Vault/02-Secret_Engine/pki-nginx.md
...
* Intermediate CSR 생성 \<pki\_intermediate.csr>
...
| `allow_glob_domains` | allowed\_domains에 지정된 이름에 glob 패턴 (예 : ftp \* .example.com)을 포함 할 수 있습니다. |
