---
url: /04-HashiCorp/06-Vault/07-Sentinel-Sample/aws-secrets-credential-type-check.md
...
## 1. EGP용 정책 생성 egp\_iam\_user\_deny.sentinel
...
EGP로 지정된 path로 credential\_type 이 iam\_user 인경우 허용된 타입이 아니므로 거부됨
