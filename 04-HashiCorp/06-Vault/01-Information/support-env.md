---
url: /04-HashiCorp/06-Vault/01-Information/support-env.md
...
| Snowflake | ✅ | ✅ | ✅ | ✅ | password (deprecated), rsa\_private\_key | Vault 1.8+ |
| **NoSQL 데이터베이스** | | | | | | |
| MongoDB | ✅ | ✅ | ✅ | ✅ | password | - |
...
* **자격 증명 타입**: 대부분의 데이터베이스는 password를 사용하며, Snowflake는 rsa\_private\_key도 지원합니다.
...
|---------|-------------|--------------|------|
| AES | 128-bit, 256-bit | - AES-GCM-128- AES-GCM-256- AES-CBC-128- AES-CBC-256 | 대칭키 암호화 알고리즘 |
| RSA | 2048-bit, 3072-bit, 4096-bit | - RSA-OAEP- RSA-PSS- RSA-PKCS1v15 | 공개키 암호화 알고리즘 |
| ECDSA | P-256, P-384, P-521 | - ECDSA-P256- ECDSA-P384- ECDSA-P521 | 타원곡선 디지털 서명 알고리즘 |
