---
url: /04-HashiCorp/08-Updates/99-2022/2022-07.md
...
* Terraform
  ...
  * Provider
    ...
    * [Azure v3.11.0 주요 수정사항](https://github.com/hashicorp/terraform-provider-azurerm/releases/tag/v3.11.0)
      * azurerm\_resource\_group\_template\_deployment 에 대한 data source 추가
      * azurerm\_managed\_disk 관련 export 지원 (disk\_access\_id 및 network\_access\_policy)
      * azurerm\_mysql\_flexible\_server 에 할당되는 resource ID 관련 오류 수정
    * [GCP v4.27.0 주요 수정사항](https://github.com/hashicorp/terraform-provider-google/releases/tag/v4.27.0)
      ...
      * Compute 에 대한 forwarding rule 설정 관련 argument 추가 (psc\_connection\_id, psc\_connection\_status)
