---
url: /04-HashiCorp/03-Terraform/02-Config/TFEAdminPasswordReset.md
description: TFE Admin 사용자 비밀 번호 변경이 필요할 경우
---
# Terraform Enterprise 사용자 비밀번호 변경

Terraform Enterprise를 사용할 때, UI(https://TFE\_SERVER) 상으로 접속할 수 없는 상황에서 비밀번호 변경이 필요한 경우, 아래와 같이 작업할 수 있다.
