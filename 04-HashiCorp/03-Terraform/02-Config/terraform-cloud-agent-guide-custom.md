---
url: /04-HashiCorp/03-Terraform/02-Config/terraform-cloud-agent-guide-custom.md
...
* 패키지 업데이트 및 각종 유틸리티 다운로드
  * aws cli는 공식 가이드를 참고합니다. (https://docs.aws.amazon.com/ko\_kr/cli/latest/userguide/getting-started-install.html)
* CA 파일 등록 : 사설인증서 등록
  * cert.crt 파일 사전에 준비
