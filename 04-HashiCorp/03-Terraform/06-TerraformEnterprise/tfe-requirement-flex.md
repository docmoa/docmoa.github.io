---
url: /04-HashiCorp/03-Terraform/06-TerraformEnterprise/tfe-requirement-flex.md
...
| 정의                   | 기본 포트 | 용도                                            |
| ---------------------- | --------- | ----------------------------------------------- |
| TFE\_HTTP\_PORT          | 80        | HTTPS로 리다이렉션                              |
| TFE\_HTTPS\_PORT         | 443       | Terraform Enterprise에 대한 모든 API 및 UI 요청 |
| TFE\_METRICS\_HTTP\_PORT  | 9090      | 메트릭 측정을 위한 HTTP 포트                    |
| TFE\_METRICS\_HTTPS\_PORT | 9091      | 메트릭 측정을 위한 HTTPS 포트                   |
