---
url: >-
  /04-HashiCorp/03-Terraform/04-TroubleShooting/error-state-snapshot-was-created-by-terraform-version.md
...
* 0.13.x로 생성된 state를 "terraform\_remote\_state"로 다른 0.12.x인 워크스페이스에서 읽어오는 경우 정상적으로 동작
