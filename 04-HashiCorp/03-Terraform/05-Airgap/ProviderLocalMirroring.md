---
url: /04-HashiCorp/03-Terraform/05-Airgap/ProviderLocalMirroring.md
...
상대적으로 설정이 간편한 filesystem\_mirror 설정 방법은 다음과 같습니다.
...
2. 다음 처럼 'provider\_installation' 설정하기
   ```
...
3. 대상 디렉토리 설정하기
   ...
   * 지정된 경로 상에 다음과 같은 HOSTNAME/NAMESPACE/TYPE/VERSION/TARGET 형태로 디렉토리 구조를 지정
     * HOSTNAME = "[registry.terraform.io](http://registry.terraform.io/)", NAMESPACE="hashicorp", TYPE="aws", VERSION="3.36.0", TARGET은 클라이언트 환경에 대한 것으로 현재 실행 환경에 따라 "darwin\_amd64", "linux\_arm" "windows\_amd64" 등으로 설정하시면 됩니다.
