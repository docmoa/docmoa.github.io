...
var me=Object.getPrototypeOf;var ve=Reflect.get;var tt=(e,t,s)=>ve(me(e),s,t);import{a8 as b,a9 as It,aa as N,ab as Pt,ac as C,ad as fe,ae as _,af as S,ag as he,ah as $e,ai as at,aj as W,ak as be,al as ge,am as ye,an as xe,ao as x,ap as Gt,aq as we,ar as F,as as Se,at as Bt,au as h,av as Ft,aw as Te,ax as ke,ay as Lt,az as K,aA as rt,aB as Ce,aC as Nt,_ as De,aD as Ae,aE as O,aF as Me,aG as Oe,aH as Ie,aI as Pe,aJ as ut,aK as Ge,aL as Be,aM as Fe,aN as Le,aO as Ne,aP as _t,aQ as et,aR as _e,aS as Re,aT as Ve,aU as Ee,aV as Rt}from"./app-DVMlqOhY.js";import{e as We,c as Ke,t as kt,A as He,l as dt,D as Ct,x as o,o as Qe,n as q,L as Vt,i as qe}from"./vidstack-rsZGrNIW-BiUwPbUx.js";class ze extends Ke{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===kt.ATTRIBUTE||t.type===kt.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Pt(this.h)):He}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=C(this.l.bind(this)))}x(t){return this.w?dt(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function i(e){return We(ze)(b(e))}class Et{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=It(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});N(()=>t.disconnect()),N(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){fe(t)?(s.textContent="",s.append(t)):(Ct(null,s),Ct(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const a=s.getAttribute("data-class");a&&n.classList.add(...a.split(" "))}Ha(t){if(t&&!t.some(a=>a.addedNodes.length))return;let s=!1,n=this._m.flatMap(a=>[...a.querySelectorAll("slot")]);for(const a of n)!a.hasAttribute("name")||this.elements.has(a)||(this.elements.add(a),s=!0);s&&this.La(this.elements)}}let Ue=0,E="data-slot-id";class Wt{constructor(t){this._m=t,this.Gc=It(this.Ha.bind(this)),this.slots=new Et(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});N(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let a=s.getAttribute(E);a||s.setAttribute(E,a=++Ue+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(E)===a)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(E,a)}}}}function je({name:e,class:t,state:s,paths:n,viewBox:a="0 0 32 32"}){return o`<svg
    class="${"vds-icon"+(t?` ${t}`:"")}"
    viewBox="${a}"
    fill="none"
    aria-hidden="true"
  ...
  `}function A({label:e,option:t,type:s}){const{player:n}=S(),{translations:a}=u(),l=at[s],r=()=>w(a,e);function c(){Ne(),n.dispatchEvent(new Event("vds-font-change"))}if(t.type==="color"){let v=function(p){l.set(p.target.value),c()};return V({label:i(r),children:o`
        <input
  ...
  `}function ws(){return i(()=>{const{translations:e}=u();return o`
    ...
    `})}function Ss(){const{userPrefersAnnouncements:e,translations:t}=u(),s="Announcements";return V({label:d(t,s),children:Y({label:s,storageKey:"vds-player::announcements",onChange(n){e.set(n)}})})}function Ts(){return i(()=>{const{translations:e,userPrefersKeyboardAnimations:t,noKeyboardAnimations:s}=u(),{viewType:n}=h();if(b(()=>n()!=="video"||s())())return null;const l="Keyboard Animations";return V({label:d(e,l),children:Y({label:l,defaultChecked:!0,storageKey:"vds-player::keyboard-animations",onChange(r){t.set(r)}})})})}function ks(){return i(()=>{const{noAudioGain:e,translations:t}=u(),{audioTracks:s,canSetAudioGain:n}=h();return b(()=>!(n()&&!e())&&s().length<=1)()?null:o`
  ...
  `}function Jt(){const{audioGains:e}=u(),t=e();return O(t)?t[0]??0:t.min}function Xt(){const{audioGains:e}=u(),t=e();return O(t)?t[t.length-1]??300:t.max}function Ms(){const{audioGains:e}=u(),t=e();return O(t)?t[1]-t[0]||25:t.step}function Os(){return i(()=>{const{translations:e}=u(),{hasCaptions:t}=h(),s=d(e,"Off");return t()?o`
  ...
  `}function se({placement:e,portal:t,tooltip:s}){return i(()=>{const{viewType:n}=h(),{translations:a,menuPortal:l,noModal:r,menuGroup:c,smallWhen:m}=u(),$=b(()=>r()?K(e):m()?null:K(e)),v=b(()=>!m()&&c()==="bottom"&&n()==="video"?26:0),p=x(!1);Je();function f(){p.set(!0)}function g(){p.set(!1)}const y=o`
      <media-menu-items
  ...
  `}function Es(){return i(()=>{const{live:e,duration:t}=h();return e()?Ut():t()?o`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function ne(){return i(()=>{const{live:e}=h();return e()?Ut():Vs()})}function ae(){return i(()=>{const{textTracks:e}=S(),{title:t,started:s}=h(),n=x(null);return Lt(e,"chapters",n.set),n()&&(s()||!t())?ie():o`<media-title class="vds-chapter-title"></media-title>`})}function ie(){return o`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class oe extends Ye{async Pf(){const t=(await De(async()=>{const{icons:n}=await import("./vidstack-CRlTZX3Z-PBDNdscv.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=je({name:n,paths:t[n]});return s}}var M;let Ws=(M=class extends P{},M.props={...tt(M,M,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576},M);function Ks(){return[ct(),ft(),o`
    ...
    `]}function Hs(){return i(()=>{let e=x(void 0),t=x(!1),s=S(),{title:n,started:a,currentTime:l,ended:r}=h(),{translations:c}=u(),m=Re(e),$=()=>a()||l()>0;const v=()=>{const g=r()?"Replay":$()?"Continue":"Play";return`${w(c,g)}: ${n()}`};C(()=>{var g;m()&&document.activeElement===document.body&&((g=s.player.el)==null||g.focus())});function p(){const g=e(),y=!!g&&!m()&&g.clientWidth<g.children[0].clientWidth;g&&Ve(g,"vds-marquee",y),t.set(y)}function f(){return o`
      ...
      `}return Nt(e,p),n()?o`
        ...
        `:D()})}function Qs(){const e="top end";return[Yt({tooltip:"top",placement:e,portal:!0}),se({tooltip:"top end",placement:e,portal:!0})]}const H=class H extends _t(Vt,Ws){constructor(){super(...arguments),this.en=x(!1)}onSetup(){this.forwardKeepAlive=!1,this.a=S(),this.classList.add("vds-audio-layout"),this.Fn()}onConnect(){Qt("audio",()=>this.isMatch),this.En()}render(){return i(this.Zm.bind(this))}Zm(){return this.isMatch?Ks():null}En(){const{menuPortal:t}=u();C(()=>{if(!this.isMatch)return;const s=Zt(this.menuContainer,"vds-audio-layout",()=>this.isSmallLayout),n=s?[this,s]:[this];return(this.$props.customIcons()?new Wt(n):new oe(n)).connect(),t.set(s),()=>{s.remove(),t.set(null)}})}Fn(){const{pointer:t}=this.a.$state;C(()=>{t()==="coarse"&&C(this.rn.bind(this))})}rn(){if(!this.en()){et(this,"pointerdown",this.sn.bind(this),{capture:!0});return}et(this,"pointerdown",t=>t.stopPropagation()),et(window,"pointerdown",this.tn.bind(this))}sn(t){const{target:s}=t;_e(s)&&s.closest(".vds-time-slider")&&(t.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),this.en.set(!0))}tn(){this.en.set(!1),this.removeAttribute("data-scrubbing")}};H.tagName="media-audio-layout",H.attrs={smallWhen:{converter(t){return t!=="never"&&!!t}}};let it=H;const L=class L extends P{};L.props={...tt(L,L,"props"),when:({viewType:t})=>t==="video",smallWhen:({width:t,height:s})=>t<576||s<380};let ot=L;function le(){return i(()=>{const e=S(),{noKeyboardAnimations:t,userPrefersKeyboardAnimations:s}=u();if(b(()=>t()||!s())())return null;const a=x(!1),{lastKeyboardAction:l}=e.$state;C(()=>{a.set(!!l());const p=setTimeout(()=>a.set(!1),500);return()=>{a.set(!1),window.clearTimeout(p)}});const r=b(()=>{var f;const p=(f=l())==null?void 0:f.action;return p&&a()?W(p):null}),c=b(()=>`vds-kb-action${a()?"":" hidden"}`),m=b(qs),$=b(()=>{const p=zs();return p?Ee(p):null});function v(){const p=$();return p?o`
  ...
  `}function Ys(){return[ct(),re(),J(),ft(),le(),o`<div class="vds-scrim"></div>`,o`
      <media-controls class="vds-controls">
        <media-controls-group class="vds-controls-group">
    ...
    `,Xs()]}function Js(){return o`
    <div class="vds-load-container">
      ${[J(),z({tooltip:"top"})]}
    </div>
  `}function Xs(){return i(()=>{const{duration:e}=h();return e()===0?null:o`
  ...
  `}function gt(){const{menuGroup:e,smallWhen:t}=u(),s=()=>e()==="top"||t()?"bottom":"top",n=b(()=>`${s()} ${e()==="top"?"end":"center"}`),a=b(()=>`${s()} end`);return[Yt({tooltip:n,placement:a,portal:!0}),se({tooltip:n,placement:a,portal:!0})]}function re(){return i(()=>{const{noGestures:e}=u();return e()?null:o`
    ...
    `})}const Q=class Q extends _t(Vt,ot){onSetup(){this.forwardKeepAlive=!1,this.a=S(),this.classList.add("vds-video-layout")}onConnect(){Qt("video",()=>this.isMatch),this.En()}render(){return i(this.Zm.bind(this))}En(){const{menuPortal:t}=u();C(()=>{if(!this.isMatch)return;const s=Zt(this.menuContainer,"vds-video-layout",()=>this.isSmallLayout),n=s?[this,s]:[this];return(this.$props.customIcons()?new Wt(n):new oe(n)).connect(),t.set(s),()=>{s.remove(),t.set(null)}})}Zm(){const{load:t}=this.a.$props,{canLoad:s,streamType:n,nativeControls:a}=this.a.$state;return!a()&&this.isMatch?t()==="play"&&!s()?Js():n()==="unknown"?J():this.isSmallLayout?Ys():Us():null}};Q.tagName="media-video-layout",Q.attrs={smallWhen:{converter(t){return t!=="never"&&!!t}}};let lt=Q;Rt(it);Rt(lt);
