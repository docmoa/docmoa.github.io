...
<span class="line"></span>
<span class="line">[중략]</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-2-command" tabindex="-1"><a class="header-anchor" href="#_1-2-command"><span>1.2 Command</span></a></h3><h4 id="_1-2-1-helm-배포" tabindex="-1"><a class="header-anchor" href="#_1-2-1-helm-배포"><span>1.2.1 helm 배포</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">helm repo add bitnami https://charts.bitnami.com/bitnami</span>
<span class="line"></span>
...
<span class="line">  </span>
<span class="line">[중략]</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><h3 id="_3-2-command" tabindex="-1"><a class="header-anchor" href="#_3-2-command"><span>3.2 Command</span></a></h3><h4 id="_3-2-1-helm-배포" tabindex="-1"><a class="header-anchor" href="#_3-2-1-helm-배포"><span>3.2.1 helm 배포</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">helm repo add bitnami https://charts.bitnami.com/bitnami</span>
...
<span class="line"></span></code></pre></div><h4 id="_3-2-2-minio-ui-접근-시-id-password-확인" tabindex="-1"><a class="header-anchor" href="#_3-2-2-minio-ui-접근-시-id-password-확인"><span>3.2.2 minio UI 접근 시 ID, Password 확인</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">kubectl get secret --namespace minio minio-dev -o jsonpath=&quot;{.data.root-user}&quot; | base64 -d</span>
<span class="line"></span>
<span class="line">kubectl get secret --namespace minio minio-dev -o jsonpath=&quot;{.data.root-password}&quot; | base64 -d</span>
<span class="line"></span></code></pre></div><h4 id="_3-2-2-fdo-연동-후-plan-apply-minio-bucket-data-확인" tabindex="-1"><a class="header-anchor" href="#_3-2-2-fdo-연동-후-plan-apply-minio-bucket-data-확인"><span>3.2.2 FDO 연동 후 plan,apply Minio bucket data 확인</span></a></h4><figure><img src="/assets/3287417026-BoLxQtej.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h1 id="_4-fdo-flexible-deployment-options-helm-배포" tabindex="-1"><a class="header-anchor" href="#_4-fdo-flexible-deployment-options-helm-배포"><span>4. FDO(Flexible Deployment Options) Helm 배포</span></a></h1><h2 id="fdo-flexible-deployment-options" tabindex="-1"><a class="header-anchor" href="#fdo-flexible-deployment-options"><span>FDO(Flexible Deployment Options)</span></a></h2><h3 id="_4-1-helm-values-yaml" tabindex="-1"><a class="header-anchor" href="#_4-1-helm-values-yaml"><span>4.1 helm values.yaml</span></a></h3><p>참고: 아래 yaml 내용은 첨부 된 FDO yaml 파일에서 설정 한 부분만 기입</p><div class="language-text line-numbers-mode has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="text" style="--vp-collapsed-lines:20;"><pre><code class="language-text"><span class="line">[중략]</span>
<span class="line"></span>
<span class="line">image:</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><h4 id="_4-1-1-command" tabindex="-1"><a class="header-anchor" href="#_4-1-1-command"><span>4.1.1 Command</span></a></h4><h4 id="_4-1-2-fdo-배포-전-image-registry-정책-설정" tabindex="-1"><a class="header-anchor" href="#_4-1-2-fdo-배포-전-image-registry-정책-설정"><span>4.1.2 FDO 배포 전 image registry 정책 설정</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">$ kubectl create secret docker-registry terraform-enterprise --docker-server=images.releases.hashicorp.com --docker-username=terraform --docker-password=$(cat { 라이선스 파일 }) -n tfe</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h4 id="_4-1-3-helm-배포" tabindex="-1"><a class="header-anchor" href="#_4-1-3-helm-배포"><span>4.1.3 helm 배포</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">helm repo add bitnami https://charts.bitnami.com/bitnami</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h4 id="_4-1-4-supervisorctl-명령어로-하여-fdo-내부-연동-된-부분을-확인-redis-postgresql-같은-경우-외부-연동" tabindex="-1"><a class="header-anchor" href="#_4-1-4-supervisorctl-명령어로-하여-fdo-내부-연동-된-부분을-확인-redis-postgresql-같은-경우-외부-연동"><span>4.1.4 supervisorctl 명령어로 하여 FDO 내부 연동 된 부분을 확인(redis, postgresql 같은 경우 외부 연동)</span></a></h4><figure><img src="/assets/3286861543-DP2DiUMW.png?width=712" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="_4-1-5-정상-helm-배포-이후-fdo-container-내부에서-아래-command로-fdo-admin-계정-생성을-위한-token-발행" tabindex="-1"><a class="header-anchor" href="#_4-1-5-정상-helm-배포-이후-fdo-container-내부에서-아래-command로-fdo-admin-계정-생성을-위한-token-발행"><span>4.1.5 정상 helm 배포 이후 FDO container 내부에서 아래 command로 FDO admin 계정 생성을 위한 Token 발행</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">tfectl admin token </span>
<span class="line"></span></code></pre></div><h4 id="_4-1-6-admin-계정-생성" tabindex="-1"><a class="header-anchor" href="#_4-1-6-admin-계정-생성"><span>4.1.6 admin 계정 생성</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">https://{ 사용하는 도메인 }/admin/account/new?token={ 발급 된 토큰 } </span>
<span class="line"></span></code></pre></div><figure><img src="/assets/3286894457-DI1RS78I.png?width=712" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h1 id="_5-fdo-backup-restore" tabindex="-1"><a class="header-anchor" href="#_5-fdo-backup-restore"><span>5. FDO Backup &amp; Restore</span></a></h1><h3 id="_5-1-백업-시-인증-토큰-필요" tabindex="-1"><a class="header-anchor" href="#_5-1-백업-시-인증-토큰-필요"><span>5.1 백업 시 인증 토큰 필요</span></a></h3><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">/bin/bash -c &#39;cat /var/run/terraform-enterprise/backup-restore/config.hcl | grep backup_token&#39;</span>
<span class="line"></span></code></pre></div><h3 id="_5-2-fdo-container-내부-토큰-발급-command" tabindex="-1"><a class="header-anchor" href="#_5-2-fdo-container-내부-토큰-발급-command"><span>5.2 FDO container 내부 토큰 발급 command</span></a></h3><h3 id="_5-3-payload-json-파일-생성" tabindex="-1"><a class="header-anchor" href="#_5-3-payload-json-파일-생성"><span>5.3 payload.json 파일 생성</span></a></h3><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">{</span>
<span class="line">  &quot;password&quot;: &quot;{ FDO helm 배포 시 설정 했던 TFE_ENCRYPTION_PASSWORD 값 }&quot;</span>
<span class="line">}</span>
<span class="line"></span></code></pre></div><h3 id="_5-4-backup-api" tabindex="-1"><a class="header-anchor" href="#_5-4-backup-api"><span>5.4 Backup api</span></a></h3><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">curl \\</span>
...
<span class="line"></span></code></pre></div><h3 id="_5-5-백업이-정상적으로-되었는지-확인" tabindex="-1"><a class="header-anchor" href="#_5-5-백업이-정상적으로-되었는지-확인"><span>5.5 백업이 정상적으로 되었는지 확인</span></a></h3><ul><li>FDO container 내부 경로: /var/log/terraform-enterprise</li></ul><figure><img src="/assets/3287351709-CCVXlw2l.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_5-6-백업-된-데이터는-curl-command를-한-경로에-생성" tabindex="-1"><a class="header-anchor" href="#_5-6-백업-된-데이터는-curl-command를-한-경로에-생성"><span>5.6 백업 된 데이터는 curl command를 한 경로에 생성</span></a></h3><h3 id="_5-7-terraform-oranization-plan-apply-정보가-저장된-fdo와-fdo와-연동-된-container를-삭제-하여-정상적으로-백업이-되는-지-확인" tabindex="-1"><a class="header-anchor" href="#_5-7-terraform-oranization-plan-apply-정보가-저장된-fdo와-fdo와-연동-된-container를-삭제-하여-정상적으로-백업이-되는-지-확인"><span>5.7 Terraform oranization, plan, apply 정보가 저장된 FDO와 FDO와 연동 된 container를 삭제 하여 정상적으로 백업이 되는 지 확인</span></a></h3><h3 id="_5-8-삭제-전" tabindex="-1"><a class="header-anchor" href="#_5-8-삭제-전"><span>5.8 삭제 전</span></a></h3><figure><img src="/assets/3287417063-9ajkFWzh.png?width=712" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_5-9-restore" tabindex="-1"><a class="header-anchor" href="#_5-9-restore"><span>5.9 Restore</span></a></h3><h4 id="_5-9-1-삭제-이후-신규-설치" tabindex="-1"><a class="header-anchor" href="#_5-9-1-삭제-이후-신규-설치"><span>5.9.1 삭제 이후 신규 설치</span></a></h4><figure><img src="/assets/3286764119-DZu8qECO.png?width=712" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="_5-9-2-신규-설치-된-fdo에-초기-설치-생성-했던-계정으로-login" tabindex="-1"><a class="header-anchor" href="#_5-9-2-신규-설치-된-fdo에-초기-설치-생성-했던-계정으로-login"><span>5.9.2 신규 설치 된 FDO에 초기 설치 생성 했던 계정으로 login</span></a></h4><figure><img src="/assets/3287286346-IfoEvvWr.png?width=712" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="_5-9-3-restore-api" tabindex="-1"><a class="header-anchor" href="#_5-9-3-restore-api"><span>5.9.3 Restore api</span></a></h4><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">curl \\</span>
...
<span class="line"></span></code></pre></div><figure><img src="/assets/3286894515-BkIaIFEr.png?width=712" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h4 id="_5-9-4-restore-이후-초기-생성-했던-계정으로-로그인" tabindex="-1"><a class="header-anchor" href="#_5-9-4-restore-이후-초기-생성-했던-계정으로-로그인"><span>5.9.4 Restore 이후 초기 생성 했던 계정으로 로그인</span></a></h4><h4 id="_5-9-5-정상적으로-계정-및-organization-workspace-및-plan-apply-정보-복구" tabindex="-1"><a class="header-anchor" href="#_5-9-5-정상적으로-계정-및-organization-workspace-및-plan-apply-정보-복구"><span>5.9.5 정상적으로 계정 및 organization, workspace 및 plan,apply 정보 복구</span></a></h4><figure><img src="/assets/3287417093-k9tepcrx.png?width=688" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h1 id="_6-velero-cluster-backup-restore" tabindex="-1"><a class="header-anchor" href="#_6-velero-cluster-backup-restore"><span>6. Velero Cluster Backup &amp; Restore</span></a></h1><h2 id="_6-1-백업-할-s3-생성" tabindex="-1"><a class="header-anchor" href="#_6-1-백업-할-s3-생성"><span>6.1 백업 할 S3 생성</span></a></h2><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">BUCKET=test-gbkim</span>
...
<span class="line"></span></code></pre></div><h2 id="_6-2-velero-설치" tabindex="-1"><a class="header-anchor" href="#_6-2-velero-설치"><span>6.2 velero 설치</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">wget https://github.com/vmware-tanzu/velero/releases/download/v1.9.2/velero-v1.9.2-linux-amd64.tar.gz</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-3-설치-완료-시-velero-container-생성" tabindex="-1"><a class="header-anchor" href="#_6-3-설치-완료-시-velero-container-생성"><span>6.3 설치 완료 시 velero container 생성</span></a></h2><figure><img src="/assets/3286796210-1anIXgQt.png?width=736" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_6-4-velero-backup" tabindex="-1"><a class="header-anchor" href="#_6-4-velero-backup"><span>6.4 velero backup</span></a></h2><ul><li>백업 대상 eks 클러스터</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">velero backup create gbkim</span>
<span class="line"></span></code></pre></div><ul><li>S3 백업 확인</li></ul><figure><img src="/assets/3287384334-DvvksWw3.png?width=736" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_6-5-restore-cluster" tabindex="-1"><a class="header-anchor" href="#_6-5-restore-cluster"><span>6.5 Restore cluster</span></a></h2><figure><img src="/assets/3286796235-kvkn7Roq.png?width=736" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_6-6-velero-restore" tabindex="-1"><a class="header-anchor" href="#_6-6-velero-restore"><span>6.6 velero restore</span></a></h2><ul><li>restore 대상 eks 클러스터에 velero 설치 된 상태에서 restore 대상<br> 클러스터에서 아래 명령어로 restore</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">velero restore create --from-backup gbkim</span>
<span class="line"></span></code></pre></div><ul><li>restore</li></ul><figure><img src="/assets/3287188089-idCVDxg0.png?width=730" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_6-7-새로운-클러스터에-정상적으로-restore가-되었는지-확인" tabindex="-1"><a class="header-anchor" href="#_6-7-새로운-클러스터에-정상적으로-restore가-되었는지-확인"><span>6.7 새로운 클러스터에 정상적으로 restore가 되었는지 확인</span></a></h2><figure><img src="/assets/3286796256-DomqsQFk.png?width=730" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>`,104)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};