import{_ as p}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as i,c as o,b as a,d as n,a as t,e as s}from"./app-DwRVeH7t.js";const c={},r=a("h1",{id:"pki-nginx-샘플",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#pki-nginx-샘플"},[a("span",null,"PKI - nginx 샘플")])],-1),u={href:"https://learn.hashicorp.com/tutorials/vault/pki-engine",target:"_blank",rel:"noopener noreferrer"},d=s(`<h2 id="vault-구성" tabindex="-1"><a class="header-anchor" href="#vault-구성"><span>Vault 구성</span></a></h2><p>환경 변수</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">export</span> <span class="token assign-left variable">VAULT_SKIP_VERIFY</span><span class="token operator">=</span>True
...
</code></pre></div><p>정책 및 사용자 구성</p><p>. ./&lt;pki-policy.hcl&gt;</p><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>$ vault policy write pki <span class="token operator">-</span> <span class="token operator">&lt;&lt;</span> <span class="token constant">EOF</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="인증-생성" tabindex="-1"><a class="header-anchor" href="#인증-생성"><span>인증 생성</span></a></h2><h3 id="user-pass-생성" tabindex="-1"><a class="header-anchor" href="#user-pass-생성"><span>user/pass 생성</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault auth <span class="token builtin class-name">enable</span> userpass
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="approle-생성" tabindex="-1"><a class="header-anchor" href="#approle-생성"><span>approle 생성</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault auth <span class="token builtin class-name">enable</span> approle
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="pki-engin" tabindex="-1"><a class="header-anchor" href="#pki-engin"><span>PKI Engin</span></a></h2><h3 id="_1단계-root-ca-생성-없는-경우" tabindex="-1"><a class="header-anchor" href="#_1단계-root-ca-생성-없는-경우"><span>1단계 : Root CA 생성 (없는 경우)</span></a></h3><ul><li><p>pki secret engine 활성화</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault secrets <span class="token builtin class-name">enable</span> <span class="token parameter variable">-path</span> pki pki
Success<span class="token operator">!</span> Enabled the database secrets engine at: pki/
</code></pre></div></li><li><p>최대 TTL (Time-to-Live)이 87600 시간(10년) 인 인증서를 발급</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault secrets tune -max-lease-ttl 87600h pki
Success<span class="token operator">!</span> Tuned the secrets engine at: pki/
</code></pre></div></li><li><p>루트 인증서 생성 <code>CA_cert.crt</code></p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> <span class="token parameter variable">-f</span> <span class="token parameter variable">-field</span><span class="token operator">=</span>certificate pki/root/generate/internal <span class="token punctuation">\\</span>
...
</code></pre></div><p>이렇게하면 새로운 자체 서명 된 CA 인증서와 개인 키가 생성됩니다. Vault는 임대 기간 (TTL)이 끝나면 생성 된 루트를 자동으로 취소합니다. CA 인증서는 자체 인증서 해지 목록 (CRL)에 서명합니다.</p></li><li><p>CA 와 CRL URL 구성</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> pki/config/urls <span class="token punctuation">\\</span>
...
</code></pre></div></li></ul><h3 id="_2단계-intermediate-ca-구성" tabindex="-1"><a class="header-anchor" href="#_2단계-intermediate-ca-구성"><span>2단계 : Intermediate CA 구성</span></a></h3><p>이전 단계에서 생성한 Root CA를 사용하여 Intermediate CA 생성</p><ul><li><p>pki secret engine 활성화</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault secrets <span class="token builtin class-name">enable</span> <span class="token parameter variable">-path</span><span class="token operator">=</span>pki_int pki
Success<span class="token operator">!</span> Enabled the pki secrets engine at: pki_int/
</code></pre></div></li><li><p>최대 TTL (Time-to-Live)이 43800 시간(5년) 인 인증서를 발급 하도록 비밀 엔진을 조정</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault secrets tune -max-lease-ttl<span class="token operator">=</span>43800h pki_int
Success<span class="token operator">!</span> Tuned the secrets engine at: pki_int/
</code></pre></div></li><li><p>Intermediate CSR 생성 &lt;pki_intermediate.csr&gt;</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> <span class="token parameter variable">-format</span><span class="token operator">=</span>json pki_int/intermediate/generate/internal <span class="token punctuation">\\</span>
...
</code></pre></div></li><li><p>Root 인증서로 Intermediate 인증서에 서명 &lt;intermediate.cert.pem&gt;</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> <span class="token parameter variable">-format</span><span class="token operator">=</span>json pki/root/sign-intermediate <span class="token assign-left variable">csr</span><span class="token operator">=</span>@pki_intermediate.csr <span class="token punctuation">\\</span>
...
</code></pre></div></li><li><p>CSR이 서명되고 Root CA가 인증서를 반환하면 다시 Vault에서 가져옴</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> <span class="token parameter variable">-f</span> pki_int/intermediate/set-signed <span class="token assign-left variable">certificate</span><span class="token operator">=</span>@intermediate.cert.pem
Success<span class="token operator">!</span> Data written to: pki_int/intermediate/set-signed
</code></pre></div></li><li><p>URL 구성</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> pki_int/config/urls <span class="token punctuation">\\</span>
...
</code></pre></div></li></ul><h3 id="_4단계-인증서-요청" tabindex="-1"><a class="header-anchor" href="#_4단계-인증서-요청"><span>4단계 : 인증서 요청</span></a></h3><blockquote><p>Vault의 단기 비밀관리의 철학은 인증서 수명을 짧게 유지하는 것입니다.</p></blockquote><ul><li><p><code>example-dot-com</code> Role에 따라 <code>test.example.com</code> 도메인에 대한 새 인증서 요청<br> (응답에는 PEM으로 인코딩 된 개인 키, 키 유형 및 인증서 일련 번호가 포함됩니다.)</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> pki_int/issue/example-dot-com <span class="token assign-left variable">common_name</span><span class="token operator">=</span><span class="token string">&quot;test.example.com&quot;</span> <span class="token assign-left variable">ttl</span><span class="token operator">=</span><span class="token string">&quot;2m&quot;</span> <span class="token comment">#format=&quot;pem_bundle&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h2 id="vault-agent" tabindex="-1"><a class="header-anchor" href="#vault-agent"><span>Vault Agent</span></a></h2><p>생성되는 PKI인증서를 자동으로 갱신하기 위해 Vault Agent 구성</p><p>secretid 생성의 예</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token variable"><span class="token variable">$(</span>vault <span class="token function">write</span> <span class="token parameter variable">-f</span> <span class="token parameter variable">-format</span><span class="token operator">=</span>json auth/approle/role/pki-agent/secret-id <span class="token operator">|</span> jq <span class="token parameter variable">-r</span> <span class="token string">&#39;.data.secret_id&#39;</span><span class="token variable">)</span></span> <span class="token operator">&gt;</span> secretid
</code></pre></div><p>[vault_agent.hcl]</p><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>pid_file <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;/root/vault_agent/pidfile&quot;</span></span>
...
</code></pre></div></li><li><p>ca.tpl</p><div class="language-ruby" data-ext="rb" data-title="rb"><pre class="language-ruby"><code><span class="token punctuation">{</span><span class="token punctuation">{</span><span class="token operator">-</span> <span class="token operator">/</span><span class="token operator">*</span> <span class="token operator">/</span>tmp<span class="token operator">/</span>cert<span class="token punctuation">.</span>tpl <span class="token operator">*</span><span class="token operator">/</span> <span class="token operator">-</span><span class="token punctuation">}</span><span class="token punctuation">}</span>
<span class="token punctuation">{</span><span class="token punctuation">{</span> with secret <span class="token string-literal"><span class="token string">&quot;pki_int/issue/example-dot-com&quot;</span></span> <span class="token string-literal"><span class="token string">&quot;common_name=test.example.com&quot;</span></span> <span class="token punctuation">}</span><span class="token punctuation">}</span>
...
</code></pre></div></li><li><p>Key.tpl</p><div class="language-ruby" data-ext="rb" data-title="rb"><pre class="language-ruby"><code><span class="token punctuation">{</span><span class="token punctuation">{</span><span class="token operator">-</span> <span class="token operator">/</span><span class="token operator">*</span> <span class="token operator">/</span>tmp<span class="token operator">/</span>key<span class="token punctuation">.</span>tpl <span class="token operator">*</span><span class="token operator">/</span> <span class="token operator">-</span><span class="token punctuation">}</span><span class="token punctuation">}</span>
<span class="token punctuation">{</span><span class="token punctuation">{</span> with secret <span class="token string-literal"><span class="token string">&quot;pki_int/issue/example-dot-com&quot;</span></span> <span class="token string-literal"><span class="token string">&quot;common_name=test.example.com&quot;</span></span> <span class="token punctuation">}</span><span class="token punctuation">}</span>
...
</code></pre></div></li></ul><h3 id="실행은-스크립트-혹은-스크립트를-서비스로-구성" tabindex="-1"><a class="header-anchor" href="#실행은-스크립트-혹은-스크립트를-서비스로-구성"><span>실행은 스크립트 혹은 스크립트를 서비스로 구성</span></a></h3>`,37),k={href:"http://start.sh",target:"_blank",rel:"noopener noreferrer"},v=s(`<div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>vault agent <span class="token parameter variable">-config</span><span class="token operator">=</span>/root/vault_agent/vault_agent.hcl -log-level<span class="token operator">=</span>debug
</code></pre></div>`,1),m=s(`<li><p>service (e.g. vault-agent.service)</p><div class="language-properties line-numbers-mode" data-ext="properties" data-title="properties"><pre class="language-properties"><code>[Unit]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>`,1),b=s(`<h2 id="appendix" tabindex="-1"><a class="header-anchor" href="#appendix"><span>Appendix</span></a></h2><h3 id="pki-관리" tabindex="-1"><a class="header-anchor" href="#pki-관리"><span>PKI 관리</span></a></h3><ul><li><p>pki revoke</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> pki_int/revoke <span class="token assign-left variable">serial_number</span><span class="token operator">=</span><span class="token string">&quot;56:ac:c0:f3:b4:1e:87:69:ec:dd:7d:27:54:f6:1c:14:91:3d:11:2d&quot;</span>
Key                        Value
---                        -----
...
</code></pre></div></li><li><p>pki rotate</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token builtin class-name">read</span> pki_int/crl/rotate
Key        Value
---        -----
success    <span class="token boolean">true</span>
</code></pre></div></li></ul><h3 id="nginx-활용" tabindex="-1"><a class="header-anchor" href="#nginx-활용"><span>Nginx 활용</span></a></h3><p>테스트 대상 시스템에 CA, Intermediated 인증서를 신뢰할 수 있는 인증서로 등록</p><p>[vault_agent.hcl]</p><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>pid_file <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;/root/vault_agent/pidfile&quot;</span></span>
...
template <span class="token punctuation">{</span>
  ...
  perms       <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;0600&quot;</span></span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>[template - pem_bundle]</p><ul><li><p>cert.tpl</p><div class="language-ruby" data-ext="rb" data-title="rb"><pre class="language-ruby"><code><span class="token punctuation">{</span><span class="token punctuation">{</span><span class="token operator">-</span> <span class="token operator">/</span><span class="token operator">*</span> <span class="token operator">/</span>tmp<span class="token operator">/</span>cert<span class="token punctuation">.</span>tpl <span class="token operator">*</span><span class="token operator">/</span> <span class="token operator">-</span><span class="token punctuation">}</span><span class="token punctuation">}</span>
...
<span class="token punctuation">{</span><span class="token punctuation">{</span> with secret <span class="token string-literal"><span class="token string">&quot;pki_int/issue/example-dot-com&quot;</span></span> <span class="token string-literal"><span class="token string">&quot;common_name=test.example.com&quot;</span></span> <span class="token string-literal"><span class="token string">&quot;ttl=2m&quot;</span></span><span class="token punctuation">}</span><span class="token punctuation">}</span>
<span class="token punctuation">{</span><span class="token punctuation">{</span> <span class="token punctuation">.</span>Data<span class="token punctuation">.</span>private_key <span class="token punctuation">}</span><span class="token punctuation">}</span><span class="token punctuation">{</span><span class="token punctuation">{</span> <span class="token keyword">end</span> <span class="token punctuation">}</span><span class="token punctuation">}</span>
</code></pre></div></li></ul><p>[/etc/nginx/sites-enabled/default]</p><blockquote><p>rotation 되면 systemctl reload nginx</p></blockquote><div class="language-properties line-numbers-mode" data-ext="properties" data-title="properties"><pre class="language-properties"><code><span class="token key attr-name">server</span> <span class="token value attr-value">{</span>
