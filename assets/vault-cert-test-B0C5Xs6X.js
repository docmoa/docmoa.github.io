...
<span class="line"></span></code></pre></div><ul><li>eks 자격증명 secret 생성</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">kubectl create secret generic eks-creds \\</span>
...
<span class="line"></span></code></pre></div><ul><li>helm 설치 및 vault repo add</li></ul><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">curl https://raw.githubusercontent.com/helm/helm/master/scripts/get-helm-3 &gt; get_helm.sh</span>
...
<span class="line"></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1-1-kubernetes에서-서명할-키-생성" tabindex="-1"><a class="header-anchor" href="#_1-1-1-kubernetes에서-서명할-키-생성"><span><a name="vault인증서-1.1.1kubernetes에서서명할키생성"></a><strong>1.1.1 Kubernetes에서 서명할 키 생성</strong></span></a></h3><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">openssl genrsa -out \${TMPDIR}/vault.key 2048</span>
<span class="line"></span></code></pre></div><h3 id="_1-1-2-인증서-서명-요청-csr-을-생성" tabindex="-1"><a class="header-anchor" href="#_1-1-2-인증서-서명-요청-csr-을-생성"><span><a name="vault인증서-1.1.2인증서서명요청(csr)을생성"></a><strong>1.1.2 인증서 서명 요청(CSR)을 생성</strong></span></a></h3><div class="language-text line-numbers-mode has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="text" style="--vp-collapsed-lines:20;"><pre><code class="language-text"><span class="line">cat &lt;&lt;EOF &gt;\${TMPDIR}/csr.conf</span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><h3 id="_1-1-3-csr을-생성" tabindex="-1"><a class="header-anchor" href="#_1-1-3-csr을-생성"><span><a name="vault인증서-1.1.3csr을생성"></a><strong>1.1.3 CSR을 생성</strong></span></a></h3><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">openssl req -config \${TMPDIR}/csr.conf -new -key \${TMPDIR}/vault.key -subj &quot;/CN=\${SERVICE}.\${NAMESPACE}.svc&quot; -out \${TMPDIR}/server.csr</span>
<span class="line"></span></code></pre></div><h3 id="_1-1-4-csr-yaml-생성" tabindex="-1"><a class="header-anchor" href="#_1-1-4-csr-yaml-생성"><span><a name="vault인증서-1.1.4csr.yaml생성"></a><strong>1.1.4 csr.yaml 생성</strong></span></a></h3><div class="hint-container warning"><p class="hint-container-title">경고</p><figure><img src="/assets/3073638458-De3TKAni.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">cat &lt;&lt;EOF &gt;\${TMPDIR}/csr.yaml</span>
<span class="line"></span>
...
<span class="line">EOF</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1-5-csr-yaml-배포" tabindex="-1"><a class="header-anchor" href="#_1-1-5-csr-yaml-배포"><span><a name="vault인증서-1.1.5csr.yaml배포"></a><strong>1.1.5 csr.yaml 배포</strong></span></a></h3><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">kubectl create -f \${TMPDIR}/csr.yaml</span>
<span class="line"></span>
<span class="line">- 승인(approve)이 되기 전까지 상태는 pending</span>
<span class="line"></span></code></pre></div><h3 id="_1-1-6-csr을-승인-요청" tabindex="-1"><a class="header-anchor" href="#_1-1-6-csr을-승인-요청"><span><a name="vault인증서-1.1.6csr을승인요청"></a><strong>1.1.6 CSR을 승인 요청</strong></span></a></h3><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">kubectl certificate approve \${CSR_NAME}</span>
<span class="line"></span></code></pre></div><h3 id="_1-1-7-승인-상태-확인" tabindex="-1"><a class="header-anchor" href="#_1-1-7-승인-상태-확인"><span><a name="vault인증서-1.1.7승인상태확인"></a><strong>1.1.7 승인 상태 확인</strong></span></a></h3><figure><img src="/assets/3073180663-fJ-ttSnF.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h1 id="_2-키-인증서-및-kubernetes-ca를-kubernetes-secret-저장" tabindex="-1"><a class="header-anchor" href="#_2-키-인증서-및-kubernetes-ca를-kubernetes-secret-저장"><span><a name="vault인증서-2.키,인증서및kubernetesca를kubernetessecret저장"></a><strong>2. 키, 인증서 및 Kubernetes CA를 Kubernetes secret 저장</strong></span></a></h1><h2 id="_2-1-crt-파일-생성" tabindex="-1"><a class="header-anchor" href="#_2-1-crt-파일-생성"><span><a name="vault인증서-2.1crt파일생성"></a><strong>2.1 crt 파일 생성</strong></span></a></h2><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">serverCert=$(kubectl get csr \${CSR_NAME} -o jsonpath=&quot;{.status.certificate}&quot;)</span>
<span class="line"></span>
<span class="line">echo &quot;\${serverCert}&quot; | openssl base64 -d -A -out \${TMPDIR}/vault.crt</span>
<span class="line"></span></code></pre></div><h2 id="_2-2-쿠버네티스-ca-설정-파일" tabindex="-1"><a class="header-anchor" href="#_2-2-쿠버네티스-ca-설정-파일"><span><a name="vault인증서-2.2쿠버네티스ca설정파일"></a><strong>2.2 쿠버네티스 ca 설정 파일</strong></span></a></h2><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">kubectl config view --raw --minify --flatten -o jsonpath=&#39;{.clusters[].cluster.certificate-authority-data}&#39; | base64 -d &gt; \${TMPDIR}/vault.ca</span>
<span class="line"></span></code></pre></div><h2 id="_2-3-key-crt-ca-인증서-시크릿-생성" tabindex="-1"><a class="header-anchor" href="#_2-3-key-crt-ca-인증서-시크릿-생성"><span><a name="vault인증서-2.3key,crt,ca인증서시크릿생성"></a><strong>2.3 key, crt, ca 인증서 시크릿 생성</strong></span></a></h2><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">kubectl create secret generic \${SECRET_NAME} \\</span>
...
<span class="line"></span></code></pre></div><h1 id="_3-vault-tls-인증서-적용" tabindex="-1"><a class="header-anchor" href="#_3-vault-tls-인증서-적용"><span><a name="vault인증서-3.vaulttls인증서적용"></a><strong>3. Vault tls 인증서 적용</strong></span></a></h1><h2 id="_3-1-helm-values-yaml-파일" tabindex="-1"><a class="header-anchor" href="#_3-1-helm-values-yaml-파일"><span><a name="vault인증서-3.1helmvalues.yaml파일"></a><strong>3.1 helm values.yaml 파일</strong></span></a></h2><div class="language-text line-numbers-mode has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="text" style="--vp-collapsed-lines:20;"><pre><code class="language-text"><span class="line">global:</span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><h2 id="_3-2-aws-nlb를-통해-접근-인증서-확인" tabindex="-1"><a class="header-anchor" href="#_3-2-aws-nlb를-통해-접근-인증서-확인"><span><a name="vault인증서-3.2awsnlb를통해접근인증서확인"></a><strong>3.2 AWS NLB를 통해 접근 인증서 확인</strong></span></a></h2><figure><img src="/assets/3073278945-A8mCEMwz.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_3-3-acm-인증서를-통해-접근" tabindex="-1"><a class="header-anchor" href="#_3-3-acm-인증서를-통해-접근"><span><a name="vault인증서-3.3acm인증서를통해접근"></a><strong>3.3 ACM 인증서를 통해 접근</strong></span></a></h2><h3 id="_3-3-1-route53-설정" tabindex="-1"><a class="header-anchor" href="#_3-3-1-route53-설정"><span><a name="vault인증서-3.3.1route53설정"></a><strong>3.3.1 Route53 설정</strong></span></a></h3><figure><img src="/assets/3073540219-B62sUFRN.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_3-3-2-레코드-생성" tabindex="-1"><a class="header-anchor" href="#_3-3-2-레코드-생성"><span><a name="vault인증서-3.3.2레코드생성"></a><strong>3.3.2 레코드 생성</strong></span></a></h3><figure><img src="/assets/3073278963-DEr13G4r.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_3-3-3-레코드-설정" tabindex="-1"><a class="header-anchor" href="#_3-3-3-레코드-설정"><span><a name="vault인증서-3.3.3레코드설정"></a><strong>3.3.3 레코드 설정</strong></span></a></h3><ul><li>레코드 이름 <ul><li>대상 도메인 이름 설정</li></ul></li><li>레코드 유형 <ul><li>A</li></ul></li><li>별칭 <ul><li>On</li></ul></li><li>트래픽 라우팅 대상 <ul><li>NLB</li><li>ap-northeast-2(서울)</li><li>사용하고자 하는 AWS 로드 밸런서 지정</li></ul></li><li>라우팅 정책 <ul><li>단순 라우팅</li></ul></li></ul><figure><img src="/assets/3073246298-Bwf6nelV.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_3-3-4-aws-인증서를-통해-vault-ui-접근" tabindex="-1"><a class="header-anchor" href="#_3-3-4-aws-인증서를-통해-vault-ui-접근"><span><a name="vault인증서-3.3.4aws인증서를통해vaultui접근"></a><strong>3.3.4 AWS 인증서를 통해 Vault UI 접근</strong></span></a></h3><figure><img src="/assets/3073311827-tOuIOnLc.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h1 id="_4-aws-private-ca를-사용-하는-인증서-생성" tabindex="-1"><a class="header-anchor" href="#_4-aws-private-ca를-사용-하는-인증서-생성"><span><a name="vault인증서-4.awsprivateca를사용하는인증서생성"></a><strong>4. AWS Private Ca를 사용 하는 인증서 생성</strong></span></a></h1><h2 id="_4-1-사전-준비-요건" tabindex="-1"><a class="header-anchor" href="#_4-1-사전-준비-요건"><span><a name="vault인증서-4.1사전준비요건"></a><strong>4.1 사전 준비 요건</strong></span></a></h2><ul><li>Private Ca 생성<br><img src="/assets/3076358550-BsPipR3Q.png?width=760" alt="" loading="lazy"></li></ul><h2 id="_4-2-acm-인증서-생성" tabindex="-1"><a class="header-anchor" href="#_4-2-acm-인증서-생성"><span><a name="vault인증서-4.2acm인증서생성"></a><strong>4.2 ACM 인증서 생성</strong></span></a></h2><ul><li><p>요청<br><img src="/assets/3076489735-CXUxbYgM.png?width=760" alt="" loading="lazy"></p></li><li><p>인증서 요청</p><ul><li>프라이빗 인증서 요청(인증서 기관이 aws가 아닌 PrivateCA로 만든 주체로 함)</li><li>다음<br><img src="/assets/3075051442-7X9Rb3XH.png?width=760" alt="" loading="lazy"></li></ul></li><li><p>인증 기관 세부 정보</p></li></ul><p><img src="/assets/3076489746-BX7yfrdL.png?width=760" alt="" loading="lazy"><br><img src="/assets/3076424567-DHLxtNxb.png?width=760" alt="" loading="lazy"></p><ul><li><p>도메인 이름<br><img src="/assets/3076424575-DXXajgpx.png?width=760" alt="" loading="lazy"></p></li><li><p>키 알고리즘<br><img src="/assets/3075051459-DUAk_V2L.png?width=760" alt="" loading="lazy"></p></li><li><p>태그</p></li><li><p>인증서 갱신 권한</p></li><li><p>요청</p></li></ul><figure><img src="/assets/3076589226-Bqhgq5nj.png?width=760" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>Private Ca에 대한 인증 기관 기반으로 인증서 생성<br><img src="/assets/3076489735-CXUxbYgM.png?width=760" alt="" loading="lazy"></li></ul><h1 id="_5-aws-private-ca-기반으로-생성-된-인증서를-vault에-적용" tabindex="-1"><a class="header-anchor" href="#_5-aws-private-ca-기반으로-생성-된-인증서를-vault에-적용"><span><a name="vault인증서-5.awsprivateca기반으로생성된인증서를vault에적용"></a><strong>5. AWS Private Ca 기반으로 생성 된 인증서를 Vault에 적용</strong></span></a></h1><ul><li><p>내보내기<br><img src="/assets/3076555196-DwOKjE-A.png?width=760" alt="" loading="lazy"></p></li><li><p>인증서 내보내기</p><ul><li>AWS 상에서 내보기를 사용하려면 비밀번호를 생성 후 내보기가 가능<br><img src="/assets/3076358579-DzCxgM3n.png?width=760" alt="" loading="lazy"></li></ul></li><li><p>내보낸 인증서</p></li><li><p>다운로드<br><img src="/assets/3076456740-CDVWfPhU.png?width=760" alt="" loading="lazy"></p></li><li><p>사설 인증서 가져오기<br><img src="/assets/3074920237-BgQN2CFj.png?width=760" alt="" loading="lazy"></p></li></ul><h1 id="결론" tabindex="-1"><a class="header-anchor" href="#결론"><span><a name="vault인증서-결론"></a><strong>결론</strong></span></a></h1><p>테스트 한 결과로는 Private Ca로 EKS 환경에서 Vault에 사설 인증서를 적용은 불가능</p><p>안되는 이유</p><hr><h1 id="진행-방식" tabindex="-1"><a class="header-anchor" href="#진행-방식"><span><a name="vault인증서-진행방식"></a><strong>진행 방식</strong></span></a></h1><ol><li>AWS Private Ca 생성</li><li>Private Ca를 통해 AWS Certificate Manager 등록 시 private 인증서 요청(csr 부분)</li></ol><ul><li>AWS Private Ca을 생성 하지 않으면 private 인증서 요청이 불가 합니다.</li></ul><ol start="3"><li>1번, 2번으로 AWS Certificate Manager에 등록이 가능합니다.</li><li>k8s에 인증서를 적용 하기 위해서는 k8s 자체적으로 csr이 필요한데 aws에서는 인증 주체가 Private Ca로 되어 있기 때문에 따로 csr파일을 제공하지 않아 k8s에 적용 할 수 없습니다.</li></ol><p>아래 참고 링크에 csr에 대한 부분에 대한 가이드 제공</p><p>참고: vault k8s 인증서 적용 공식 문서</p><ul><li><a href="https://developer.hashicorp.com/vault/docs/platform/k8s/helm/examples/standalone-tls" target="_blank" rel="noopener noreferrer">https://developer.hashicorp.com/vault/docs/platform/k8s/helm/examples/standalone-tls</a></li></ul><h2 id="대안" tabindex="-1"><a class="header-anchor" href="#대안"><span><a name="vault인증서-대안"></a><strong>대안</strong></span></a></h2><ul><li>위 테스트 통한 방법으로 하게 되면 aws 인증서(ACM)를 관리 하지 않기 때문에 인증서 갱신 시 수동으로 갱신을 해야 하는 번거로움이 있습니다.</li></ul><p>⇒ 대안으로 eks 환경에서는 container로 사설 인증서를 관리 해주는 container(cert-manager)를 제공 할 수 있는데 이 container로 인증서를 자동으로 갱신 할 수 있습니다.</p><p>참고</p><ol><li><a href="https://aws.amazon.com/ko/blogs/containers/setting-up-end-to-end-tls-encryption-on-amazon-eks-with-the-new-aws-load-balancer-controller/" target="_blank" rel="noopener noreferrer">https://aws.amazon.com/ko/blogs/containers/setting-up-end-to-end-tls-encryption-on-amazon-eks-with-the-new-aws-load-balancer-controller/</a></li><li><a href="https://cleanupthedesk.tistory.com/43" target="_blank" rel="noopener noreferrer">https://cleanupthedesk.tistory.com/43</a></li></ol><p>Created by 김기범(<a href="mailto:rlarlqja1001@gmail.com" target="_blank" rel="noopener noreferrer">rlarlqja1001@gmail.com</a>)</p>`,78)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};