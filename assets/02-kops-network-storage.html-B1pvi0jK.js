import{_ as l}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as p,c,b as n,d as s,a as e,e as t}from"./app-DwRVeH7t.js";const o={},r=t(`<h1 id="pkos-2편-네트워크-스토리지" tabindex="-1"><a class="header-anchor" href="#pkos-2편-네트워크-스토리지"><span>[PKOS] 2편 - 네트워크 &amp; 스토리지</span></a></h1><p>지난 1주차 스터디에이어 2주차 스터디를 진행하였습니다. 이번 스터디에서는 &quot;쿠버네티스 네트워크&quot; 및 &quot;쿠버네티스 스토리지&quot;를 중심으로 학습하였습니다.</p><blockquote><p>참고 :<br> 원활한 실습을 위해 인스턴스 타입을 변경한 후 진행합니다.</p></blockquote><h2 id="_0-사전준비" tabindex="-1"><a class="header-anchor" href="#_0-사전준비"><span>0. 사전준비</span></a></h2><h3 id="_1-kops-클러스터의-인스턴-그룹-변경" tabindex="-1"><a class="header-anchor" href="#_1-kops-클러스터의-인스턴-그룹-변경"><span>1) Kops 클러스터의 인스턴 그룹 변경</span></a></h3><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kops get ig
...
</code></pre></div><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code>kops edit ig master<span class="token punctuation">-</span>ap<span class="token punctuation">-</span>northeast<span class="token punctuation">-</span>2a
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>확인</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kops get ig
NAME			ROLE	MACHINETYPE	MIN	MAX	ZONES
...
</code></pre></div><ul><li>Cluster Update 수행</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kops update cluster <span class="token parameter variable">--name</span> pkos.hyungwook.link <span class="token parameter variable">--yes</span>

kops rolling-update cluster <span class="token parameter variable">--yes</span>
</code></pre></div><hr><h2 id="_2-nlb" tabindex="-1"><a class="header-anchor" href="#_2-nlb"><span>2. NLB</span></a></h2><h3 id="_1-nlb-mode-정리" tabindex="-1"><a class="header-anchor" href="#_1-nlb-mode-정리"><span>1) NLB Mode 정리</span></a></h3><h4 id="_1-인스턴스-유형" tabindex="-1"><a class="header-anchor" href="#_1-인스턴스-유형"><span>(1) 인스턴스 유형</span></a></h4><ol><li><code>externalTrafficPolicy</code> : ClusterIP ⇒ 2번 분산 및 SNAT으로 Client IP 확인 불가능 ← <code>LoadBalancer</code> 타입 (기본 모드) 동작</li><li><code>externalTrafficPolicy</code> : Local ⇒ 1번 분산 및 ClientIP 유지, 워커 노드의 iptables 사용함</li></ol><ul><li>이미지 출처 : PKOS 스터디 - 가시다님</li></ul><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/IMeYr3.jpg" alt="NLB 이미지1" tabindex="0" loading="lazy"><figcaption>NLB 이미지1</figcaption></figure><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/rV5KOK.jpg" alt="NLB 이미지2" tabindex="0" loading="lazy"><figcaption>NLB 이미지2</figcaption></figure><h4 id="_2-ip-유형" tabindex="-1"><a class="header-anchor" href="#_2-ip-유형"><span>(2) IP 유형</span></a></h4><blockquote><p>반드시 AWS LoadBalancer 컨트롤러 파드 및 정책 설정이 필요함!</p></blockquote><ol><li><code>Proxy Protocol v2 비활성화</code> ⇒ NLB에서 바로 파드로 인입, 단 ClientIP가 NLB로 SNAT 되어 Client IP 확인 불가능</li><li><code>Proxy Protocol v2 활성화</code> ⇒ NLB에서 바로 파드로 인입 및 ClientIP 확인 가능(→ 단 PPv2 를 애플리케이션이 인지할 수 있게 설정 필요)</li></ol><h3 id="_2-서비스-배포" tabindex="-1"><a class="header-anchor" href="#_2-서비스-배포"><span>2) 서비스 배포</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 작업용 EC2 - 디플로이먼트 &amp; 서비스 생성</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>Listener 확인</li></ul><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/rZx1tE.jpg" alt="Listener" tabindex="0" loading="lazy"><figcaption>Listener</figcaption></figure><ul><li>Target Group 확인</li></ul><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/kQcEaN.jpg" alt="TargetGroup 확인" tabindex="0" loading="lazy"><figcaption>TargetGroup 확인</figcaption></figure><ul><li>실제 Pod의 IP 정보 확인</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>k get pods <span class="token parameter variable">-o</span> wide
...
</code></pre></div><h3 id="_3-접속확인" tabindex="-1"><a class="header-anchor" href="#_3-접속확인"><span>3) 접속확인</span></a></h3><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/uVSCZA.jpg" alt="접속확인" tabindex="0" loading="lazy"><figcaption>접속확인</figcaption></figure><h2 id="_3-nlb에-tls-적용하기-feat-acm" tabindex="-1"><a class="header-anchor" href="#_3-nlb에-tls-적용하기-feat-acm"><span>3. NLB에 TLS 적용하기(feat. ACM)</span></a></h2><blockquote><p>사전 준비 :<br> 공인도메인 소유, AWS Route53 도메인등록 상태, NLB 가 위치한 리전(서울)의 인증서 요청/발급 완료상태, ExternalDNS 준비완료 상태</p></blockquote><h3 id="_1-환경구성" tabindex="-1"><a class="header-anchor" href="#_1-환경구성"><span>1) 환경구성</span></a></h3><ul><li>ACM 인증서 및 ARN 확인</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 사용 리전의 인증서 ARN 확인</span>
...
</code></pre></div><ul><li>NLB와 ACM에서 사용할 도메인 등록</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 자신의 도메인 변수 지정</span>
...
</code></pre></div><h3 id="_2-샘플-애플리케이션-배포" tabindex="-1"><a class="header-anchor" href="#_2-샘플-애플리케이션-배포"><span>2) 샘플 애플리케이션 배포</span></a></h3><ul><li>Deploy, SVC YAML</li></ul><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code>cat &lt;&lt;EOF <span class="token punctuation">|</span> kubectl create <span class="token punctuation">-</span>f <span class="token punctuation">-</span>
...
<span class="token key atrule">spec</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">selector</span><span class="token punctuation">:</span>
    <span class="token key atrule">app</span><span class="token punctuation">:</span> deploy<span class="token punctuation">-</span>websrv
EOF
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>생성된 SVC의 annotation 확인</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl describe svc svc-nlb-ip-type <span class="token operator">|</span> <span class="token function">grep</span> Annotations: <span class="token parameter variable">-A8</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-인증서-적용-확인" tabindex="-1"><a class="header-anchor" href="#_3-인증서-적용-확인"><span>3) 인증서 적용 확인</span></a></h3><h4 id="_1-cli-확인" tabindex="-1"><a class="header-anchor" href="#_1-cli-확인"><span>(1) CLI 확인</span></a></h4><ul><li><code>insecure</code> 옵션 없이 정상적으로 curl 응답 하는 것을 확인할 수 있습니다.</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-s</span> http://websrv.pkos.hyungwook.link <span class="token operator">|</span> <span class="token function">grep</span> Hostname
...
</code></pre></div><h4 id="_2-웹-브라우저-확인" tabindex="-1"><a class="header-anchor" href="#_2-웹-브라우저-확인"><span>(2) 웹 브라우저 확인</span></a></h4><ul><li><strong>&quot;이 연결은 안전합니다.&quot;</strong> 메시지를 통해 실제 ACM 퍼블릭 인증서가 적용된 것을 확인할 수 있습니다.</li></ul><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/OPTdsH.jpg" alt="인증서 적용 확인" tabindex="0" loading="lazy"><figcaption>인증서 적용 확인</figcaption></figure><h2 id="_3-ingress" tabindex="-1"><a class="header-anchor" href="#_3-ingress"><span>3. Ingress</span></a></h2><p>클러스터 내부의 서비스(ClusterIP, NodePort, Loadbalancer)를 외부로 노출(HTTP/HTTPS) - Web Proxy 역할</p><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/u5cdKs.jpg" alt="ingress" tabindex="0" loading="lazy"><figcaption>ingress</figcaption></figure><h3 id="_1-환경구성-1" tabindex="-1"><a class="header-anchor" href="#_1-환경구성-1"><span>1) 환경구성</span></a></h3><ul><li>AWS LoadBalancerControllerIAMPolicy 정책 생성 및 추가</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># EC2 instance profiles 에 IAM Policy 추가(attach)</span>
...
aws iam attach-role-policy --policy-arn arn:aws:iam::<span class="token variable">$ACCOUNT_ID</span>:policy/AWSLoadBalancerControllerIAMPolicy --role-name masters.<span class="token variable">$KOPS_CLUSTER_NAME</span>
aws iam attach-role-policy --policy-arn arn:aws:iam::<span class="token variable">$ACCOUNT_ID</span>:policy/AWSLoadBalancerControllerIAMPolicy --role-name nodes.<span class="token variable">$KOPS_CLUSTER_NAME</span>
</code></pre></div><ul><li>Kops 클러스터 ExternalDNS 및 certManager 설정 추가</li></ul><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token comment"># kOps 클러스터 편집 : 아래 내용 추가</span>
kops edit cluster
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>변경된 설정 업데이트 반영</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 업데이트 적용</span>
...
</code></pre></div><h3 id="_2-서비스-파드-배포-테스트-with-ingress-alb" tabindex="-1"><a class="header-anchor" href="#_2-서비스-파드-배포-테스트-with-ingress-alb"><span>2) 서비스/파드 배포 테스트 with Ingress(ALB)\\</span></a></h3><ul><li>서비스 배포</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 게임 파드와 Service, Ingress 배포</span>
kubectl apply <span class="token parameter variable">-f</span> ~/pkos/3/ingress1.yaml
</code></pre></div><ul><li>서비스 배포 후 Target Type이 IP로 생성된 것 확인</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl get targetgroupbindings <span class="token parameter variable">-n</span> game-2048
NAME                               SERVICE-NAME   SERVICE-PORT   TARGET-TYPE   AGE
k8s-game2048-service2-e48050abac   service-2048   <span class="token number">80</span>             <span class="token function">ip</span>            87s
</code></pre></div><ul><li>Ingress 정보 확인</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl describe ingress <span class="token parameter variable">-n</span> game-2048 ingress-2048
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>ALB 접속 확인</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 게임 접속 : ALB 주소로 웹 접속</span>
...
</code></pre></div><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/KTZTUM.jpg" alt="게임화면" tabindex="0" loading="lazy"><figcaption>게임화면</figcaption></figure><ul><li>리소스 삭제</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl delete ingress ingress-2048 <span class="token parameter variable">-n</span> game-2048
...
</code></pre></div><h2 id="_4-쿠버네티스-스토리지-ebs" tabindex="-1"><a class="header-anchor" href="#_4-쿠버네티스-스토리지-ebs"><span>4. 쿠버네티스 스토리지 : EBS</span></a></h2><h3 id="_1-환경구성-2" tabindex="-1"><a class="header-anchor" href="#_1-환경구성-2"><span>1) 환경구성</span></a></h3>`,75),u=n("code",null,"c5d.large",-1),d={href:"https://docs.aws.amazon.com/ko_kr/AWSEC2/latest/UserGuide/InstanceStorage.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://docs.aws.amazon.com/ko_kr/AWSEC2/latest/UserGuide/ssd-instance-store.html",target:"_blank",rel:"noopener noreferrer"},m=t(`<ul><li>데이터 손실 : 기본 디스크 드라이브 오류, 인스턴스가 중지됨, 인스턴스가 최대 절전 모드로 전환됨, 인스턴스가 종료됨</li></ul><figure><img src="https://docs.aws.amazon.com/ko_kr/AWSEC2/latest/UserGuide/images/instance_storage.png" alt="       Amazon EC2 인스턴스 스토리지     " tabindex="0" loading="lazy"><figcaption> Amazon EC2 인스턴스 스토리지 </figcaption></figure><ul><li>임시스토리지 실습을 위한 환경 구성</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 인스턴스 스토어 볼륨이 있는 c5 모든 타입의 스토리지 크기</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>워커 노드 스토리지 확인 : nvme 명령도구 설치 및 확인</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">ssh</span> <span class="token parameter variable">-i</span> ~/.ssh/id_rsa ubuntu@<span class="token variable">$W1PIP</span> <span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> <span class="token parameter variable">-y</span> nvme-cli
...
</code></pre></div><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/6iX9dg.jpg" alt="nvme_list" tabindex="0" loading="lazy"><figcaption>nvme_list</figcaption></figure><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 워커 노드 스토리지 확인 : NVMe SSD 인스턴스 스토어 볼륨 확인</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-hostpath-실습" tabindex="-1"><a class="header-anchor" href="#_2-hostpath-실습"><span>2) HostPath 실습</span></a></h3><h4 id="_1-hostpath스토리지-클래스-배포" tabindex="-1"><a class="header-anchor" href="#_1-hostpath스토리지-클래스-배포"><span>(1) HostPath스토리지 클래스 배포</span></a></h4>`,10),b={href:"https://github.com/rancher/local-path-provisioner",target:"_blank",rel:"noopener noreferrer"},k=t(`<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 마스터노드의 이름 확인해두기</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-pv-pvc-샘플-배포" tabindex="-1"><a class="header-anchor" href="#_2-pv-pvc-샘플-배포"><span>(2) PV / PVC 샘플 배포</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># PVC 생성</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>데이터 생성확인</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 파드 데이터 확인 : app-localpath 파드에서 데이터 쌓이는 것 확인</span>
...
Sun Jan <span class="token number">29</span> 05:13:45 UTC <span class="token number">2023</span>
<span class="token punctuation">..</span>.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/Y6CYPg.jpg" alt="데이터확인" tabindex="0" loading="lazy"><figcaption>데이터확인</figcaption></figure><blockquote><p>LocalPath 성능측정은 추후 별도 정리 후 업로드 예정</p></blockquote><h3 id="_3-aws-ebs-controller" tabindex="-1"><a class="header-anchor" href="#_3-aws-ebs-controller"><span>3) AWS EBS Controller</span></a></h3>`,8),h={href:"https://github.com/kubernetes-sigs/aws-ebs-csi-driver",target:"_blank",rel:"noopener noreferrer"},g=t(`<ul><li>이미지 출처 : PKOS 스터디 - 가시다</li></ul><figure><img src="https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/dGge8O.jpg" alt="EBS Controller" tabindex="0" loading="lazy"><figcaption>EBS Controller</figcaption></figure><h4 id="_1-ebs-driver-배포확인" tabindex="-1"><a class="header-anchor" href="#_1-ebs-driver-배포확인"><span>(1) EBS Driver 배포확인</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># EBS Driver 확인 Kops 설치 시 기본 배포</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-pv-pvc-샘플-배포-1" tabindex="-1"><a class="header-anchor" href="#_2-pv-pvc-샘플-배포-1"><span>(2) PV / PVC 샘플 배포</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># PVC 생성</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-번외-pvc-데이터-증설" tabindex="-1"><a class="header-anchor" href="#_3-번외-pvc-데이터-증설"><span>(3) (번외) PVC 데이터 증설</span></a></h4><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 현재 pv 의 이름을 기준하여 4G &gt; 10G 로 증가 : .spec.resources.requests.storage의 4Gi 를 10Gi로 변경</span>
...
</code></pre></div><ul><li>리소스 삭제</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl delete pod app <span class="token operator">&amp;</span> kubectl delete pvc ebs-claim
</code></pre></div><h2 id="_5-마무리" tabindex="-1"><a class="header-anchor" href="#_5-마무리"><span>5. 마무리</span></a></h2><p>이번 글에서는 Kops 환경에서의 네트워크와 스토리지를 활용하는 방법을 정리해보았습니다.</p><p>일반적인 K8s와 달리 AWS 환경에서 EKS, Kops 등을 활용하게 된다면, AWS 리소스와의 연계를 통해 관리의 효율성과 편의성을 체감할 수 있었습니다.</p><p>다만, K8s만 알고 AWS는 잘 모르거나 또 그 반대의 상황에는 진입장벽이 있을 수 있겠다는 생각이 들었네요. 물론 이러한 부분만 해소된다면 관리형 쿠버네티스를 200% 활용할 수 있을 것 같습니다.</p><p>다음시간에는 GitOps와 관련된 주제로 찾아올 예정입니다.</p>`,15);function f(y,P){const a=i("ExternalLinkIcon");return p(),c("div",null,[r,n("p",null,[u,s(" 의 EC2 인스턴스 스토어(임시 블록 스토리지) 설정 작업 - "),n("a",d,[s("링크"),e(a)]),s(" , NVMe SSD - "),n("a",v,[s("링크"),e(a)])]),m,n("ul",null,[n("li",null,[s("호스트 Path 를 사용하는 PV/PVC : local-path-provisioner 스트리지 클래스 배포 - "),n("a",b,[s("링크"),e(a)])])]),k,n("p",null,[s("Volume (ebs-csi-controller) : EBS CSI driver 동작 : 볼륨 생성 및 파드에 볼륨 연결 - "),n("a",h,[s("링크"),e(a)])]),g])}const S=l(o,[["render",f],["__file","02-kops-network-storage.html.vue"]]),E=JSON.parse('{"path":"/02-PrivatePlatform/Kubernetes/05-Kops/02-kops-network-storage.html","title":"[PKOS] 2편 - 네트워크 & 스토리지","lang":"ko-KR","frontmatter":{"description":"AWS Kops 설치 및 기본 사용","tag":["Kubernetes","Kops","EKS","PKOS"],"head":[["meta",{"property":"og:url","content":"https://docmoa.github.io/02-PrivatePlatform/Kubernetes/05-Kops/02-kops-network-storage.html"}],["meta",{"property":"og:site_name","content":"docmoa"}],["meta",{"property":"og:title","content":"[PKOS] 2편 - 네트워크 & 스토리지"}],["meta",{"property":"og:description","content":"AWS Kops 설치 및 기본 사용"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/IMeYr3.jpg"}],["meta",{"property":"og:locale","content":"ko-KR"}],["meta",{"property":"og:updated_time","content":"2023-09-18T13:12:54.000Z"}],["meta",{"property":"article:tag","content":"Kubernetes"}],["meta",{"property":"article:tag","content":"Kops"}],["meta",{"property":"article:tag","content":"EKS"}],["meta",{"property":"article:tag","content":"PKOS"}],["meta",{"property":"article:modified_time","content":"2023-09-18T13:12:54.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"[PKOS] 2편 - 네트워크 & 스토리지\\",\\"image\\":[\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/IMeYr3.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/rV5KOK.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/rZx1tE.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/kQcEaN.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/uVSCZA.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/OPTdsH.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/u5cdKs.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/KTZTUM.jpg\\",\\"https://docs.aws.amazon.com/ko_kr/AWSEC2/latest/UserGuide/images/instance_storage.png\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/6iX9dg.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/Y6CYPg.jpg\\",\\"https://raw.githubusercontent.com/hyungwook0221/img/main/uPic/dGge8O.jpg\\"],\\"dateModified\\":\\"2023-09-18T13:12:54.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"0. 사전준비","slug":"_0-사전준비","link":"#_0-사전준비","children":[{"level":3,"title":"1) Kops 클러스터의 인스턴 그룹 변경","slug":"_1-kops-클러스터의-인스턴-그룹-변경","link":"#_1-kops-클러스터의-인스턴-그룹-변경","children":[]}]},{"level":2,"title":"2. NLB","slug":"_2-nlb","link":"#_2-nlb","children":[{"level":3,"title":"1) NLB Mode 정리","slug":"_1-nlb-mode-정리","link":"#_1-nlb-mode-정리","children":[]},{"level":3,"title":"2) 서비스 배포","slug":"_2-서비스-배포","link":"#_2-서비스-배포","children":[]},{"level":3,"title":"3) 접속확인","slug":"_3-접속확인","link":"#_3-접속확인","children":[]}]},{"level":2,"title":"3. NLB에 TLS 적용하기(feat. ACM)","slug":"_3-nlb에-tls-적용하기-feat-acm","link":"#_3-nlb에-tls-적용하기-feat-acm","children":[{"level":3,"title":"1) 환경구성","slug":"_1-환경구성","link":"#_1-환경구성","children":[]},{"level":3,"title":"2) 샘플 애플리케이션 배포","slug":"_2-샘플-애플리케이션-배포","link":"#_2-샘플-애플리케이션-배포","children":[]},{"level":3,"title":"3) 인증서 적용 확인","slug":"_3-인증서-적용-확인","link":"#_3-인증서-적용-확인","children":[]}]},{"level":2,"title":"3. Ingress","slug":"_3-ingress","link":"#_3-ingress","children":[{"level":3,"title":"1) 환경구성","slug":"_1-환경구성-1","link":"#_1-환경구성-1","children":[]},{"level":3,"title":"2) 서비스/파드 배포 테스트 with Ingress(ALB)\\\\","slug":"_2-서비스-파드-배포-테스트-with-ingress-alb","link":"#_2-서비스-파드-배포-테스트-with-ingress-alb","children":[]}]},{"level":2,"title":"4. 쿠버네티스 스토리지 : EBS","slug":"_4-쿠버네티스-스토리지-ebs","link":"#_4-쿠버네티스-스토리지-ebs","children":[{"level":3,"title":"1) 환경구성","slug":"_1-환경구성-2","link":"#_1-환경구성-2","children":[]},{"level":3,"title":"2) HostPath 실습","slug":"_2-hostpath-실습","link":"#_2-hostpath-실습","children":[]},{"level":3,"title":"3) AWS EBS Controller","slug":"_3-aws-ebs-controller","link":"#_3-aws-ebs-controller","children":[]}]},{"level":2,"title":"5. 마무리","slug":"_5-마무리","link":"#_5-마무리","children":[]}],"git":{"createdTime":1695042774000,"updatedTime":1695042774000,"contributors":[{"name":"Great-Stone","email":"hahohh@gmail.com","commits":1}]},"readingTime":{"minutes":36.15,"words":2169},"filePathRelative":"02-PrivatePlatform/Kubernetes/05-Kops/02-kops-network-storage.md","localizedDate":"2023년 9월 18일","excerpt":"\\n<p>지난 1주차 스터디에이어 2주차 스터디를 진행하였습니다. 이번 스터디에서는 \\"쿠버네티스 네트워크\\" 및 \\"쿠버네티스 스토리지\\"를 중심으로 학습하였습니다.</p>\\n<blockquote>\\n<p>참고 :<br>\\n원활한 실습을 위해 인스턴스 타입을 변경한 후 진행합니다.</p>\\n</blockquote>\\n<h2>0. 사전준비</h2>\\n<h3>1) Kops 클러스터의 인스턴 그룹 변경</h3>\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code>kops get ig\\nNAME\\t\\t\\tROLE\\tMACHINETYPE\\tMIN\\tMAX\\tZONES\\nmaster-ap-northeast-2a\\tMaster\\tt3.medium\\t<span class=\\"token number\\">1</span>\\t<span class=\\"token number\\">1</span>\\tap-northeast-2a\\nnodes-ap-northeast-2a\\tNode\\tt3.medium\\t<span class=\\"token number\\">1</span>\\t<span class=\\"token number\\">1</span>\\tap-northeast-2a\\nnodes-ap-northeast-2c\\tNode\\tt3.medium\\t<span class=\\"token number\\">1</span>\\t<span class=\\"token number\\">1</span>\\tap-northeast-2c\\n</code></pre></div>"}');export{S as comp,E as data};
