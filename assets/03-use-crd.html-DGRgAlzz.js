...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>서비스는 Consul이 각 서비스에 대한 프록시를 자동으로 삽입할 수 있도록 하는 <code>annotation</code> 을 사용합니다. 프록시 는 Consul의 구성을 기반으로 서비스 간의 요청을 처리하기 위해 <strong>데이터 플레인을 생성합니다.</strong> Consul이 주입되는 label을 선택하여 프록시가 있는 응용 프로그램을 확인할 수 있습니다.</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl get pods <span class="token parameter variable">--selector</span> consul.hashicorp.com/connect-inject-status<span class="token operator">=</span>injected
...
</code></pre></div><p>배포된 앱에 접근하기 위해 <code>port-forward</code>를 구성합니다.</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl port-forward service/frontend <span class="token number">18080</span>:80 <span class="token parameter variable">--address</span> <span class="token number">0.0</span>.0.0
</code></pre></div><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 출력</span>
...
</code></pre></div>`,10),H={href:"http://localhost:18080",target:"_blank",rel:"noopener noreferrer"},N=t('<figure><img src="'+d+'" alt="image-20220219202023073" tabindex="0" loading="lazy"><figcaption>image-20220219202023073</figcaption></figure><p>현재 <code>Intention</code> 규칙이 모두 <code>deny</code>로 구성되어있다면 에러 화면을 확인하게 됩니다.</p><figure><img src="'+p+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="crd-적용해보기" tabindex="-1"><a class="header-anchor" href="#crd-적용해보기"><span>CRD 적용해보기</span></a></h2><p>UI에서가 아닌 CRD를 통해 <code>Intention</code> 을 정의하기위해 아래와 같이 구성합니다.</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">cat</span> <span class="token operator">&gt;</span> ./service-to-service.yaml <span class="token operator">&lt;&lt;</span><span class="token string">EOF
...
spec:
  ...
  sources:
    - name: product-api
      action: allow
EOF</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>규칙의 내용은 다음과 같습니다.</p><ul><li>frontend -&gt; public-api</li><li>public-api -&gt; product-api</li><li>product-api -&gt; postgres</li></ul><p>규칙을 적용합니다.</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl apply <span class="token parameter variable">-f</span> service-to-service.yaml
</code></pre></div><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 출력</span>
...
</code></pre></div><p>Consul UI에서 확인해보면 해당 Intention 규칙은 CRD로 적용되었기 때문에 <code>Managed by CRD</code> 표시가 붙는것을 확인할 수 있습니다.</p><figure><img src="`+u+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>배포된 앱에 접근하기 위해 <code>port-forward</code>를 구성합니다.</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl port-forward service/frontend <span class="token number">18080</span>:80 <span class="token parameter variable">--address</span> <span class="token number">0.0</span>.0.0
</code></pre></div><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 출력</span>
Forwarding from <span class="token number">0.0</span>.0.0:18080 -<span class="token operator">&gt;</span> <span class="token number">80</span>
</code></pre></div>`,16),V={href:"http://localhost:18080",target:"_blank",rel:"noopener noreferrer"},B=t('<figure><img src="'+m+`" alt="image-20220219202943498" tabindex="0" loading="lazy"><figcaption>image-20220219202943498</figcaption></figure><p>서비스 간 연결이 허용되었으므로 페이지가 잘 표시됩니다.</p><p>다음 과정을 위해 배포된 리소스를 정리합니다.</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl delete <span class="token parameter variable">-f</span> service-to-service.yaml
</code></pre></div><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 출력</span>
...
</code></pre></div><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kubectl delete <span class="token parameter variable">-f</span> hashicups/
</code></pre></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 출력</span>
