...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div><ol start="2"><li>Vault gitlab jwt 연동</li></ol><ul><li>Gitlab CI에서 Vault의 인증인가를 받기 위해 JWT 연동을 진행합니다. <ul><li>해당 auth의 role에 token policy는 1번에서 생성한 nomad secret engine의 접근 가능하게 설정합니다.</li></ul></li></ul><div class="language-hcl has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="hcl" style="--vp-collapsed-lines:20;"><pre><code class="language-hcl"><span class="line"><span class="token keyword">resource <span class="token type variable">&quot;vault_jwt_auth_backend&quot;</span></span> <span class="token string">&quot;gitlab&quot;</span> <span class="token punctuation">{</span></span>
...
<span class="line">  <span class="token punctuation">}</span>  </span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="collapsed-lines"></div></div><ol start="3"><li>Gitlab-CI 설정</li></ol><ul><li>.gitlab-ci.yml 파일입니다. <ul><li>파이프라인 전체는 아니며 Gitlab ci에서 Vault의 인증인가를 받고 Nomad Token을 활용하는 CD 단계로 보시면 됩니다.</li><li>bound_audiences에 기입 한 값 기준으로 체크 후 임시 Token을 발급받습니다.</li><li>jwt Token을 기반으로 미리 연동해 둔 gitlab-role에 대한 token을 받아옵니다.</li><li>gitlab-role token을 활용하여 Nomad token을 다음 stage로 넘겨줍니다.</li></ul></li></ul><div class="language-yaml has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="yml" style="--vp-collapsed-lines:20;"><pre><code class="language-yaml"><span class="line"><span class="token punctuation">---</span></span>
