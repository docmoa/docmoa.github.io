import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as e,e as a}from"./app-DwRVeH7t.js";const t={},o=a(`<h1 id="aws-secrets-role-type-check" tabindex="-1"><a class="header-anchor" href="#aws-secrets-role-type-check"><span>AWS Secrets Role Type Check</span></a></h1><h2 id="_1-egp용-정책-생성-egp-iam-user-deny-sentinel" tabindex="-1"><a class="header-anchor" href="#_1-egp용-정책-생성-egp-iam-user-deny-sentinel"><span>1. EGP용 정책 생성 egp_iam_user_deny.sentinel</span></a></h2><div class="language-hcl line-numbers-mode" data-ext="hcl" data-title="hcl"><pre class="language-hcl"><code>import <span class="token string">&quot;strings&quot;</span>
...
<span class="token property">main</span> <span class="token punctuation">=</span> rule when <span class="token keyword">precond</span> <span class="token punctuation">{</span>
    role_type_check
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>precond</code> : API 요청이 POST, UPDATE 인 경우</li><li><code>role_type_check</code> : 요청의 Body에 <code>credential_type</code>의 값이 허용된 type 인지 확인 (e.g. <code>federation_token</code> 허용)</li></ul><h2 id="_2-egp에-정책-설정" tabindex="-1"><a class="header-anchor" href="#_2-egp에-정책-설정"><span>2. EGP에 정책 설정</span></a></h2><p>EGP는 지정된 path에 대해 정책을 적용</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> /sys/policies/egp/iam_user_deny <span class="token punctuation">\\</span>
...
</code></pre></div><ul><li><code>paths</code>로 지정된 API 경로에 요청이 들어오면 동작</li></ul><h2 id="_3-테스트" tabindex="-1"><a class="header-anchor" href="#_3-테스트"><span>3. 테스트</span></a></h2><p>EGP로 지정된 path로 credential_type 이 iam_user 인경우 허용된 타입이 아니므로 거부됨</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> aws/roles/iam-role <span class="token punctuation">\\</span>
...
EOF</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>에러 메시지</p><div class="language-log line-numbers-mode" data-ext="log" data-title="log"><pre class="language-log"><code><span class="token property">Error writing data to aws/roles/iam-role:</span> Error making API request<span class="token punctuation">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>federation_token</code>은 생성됩니다.</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault <span class="token function">write</span> aws/roles/sts-role <span class="token punctuation">\\</span>
