import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as p,o as i,c as l,b as n,d as s,a as c,e as a}from"./app-DwRVeH7t.js";const o={},u=n("h1",{id:"consul-namespace-사용시-nomad의-서비스-등록",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#consul-namespace-사용시-nomad의-서비스-등록"},[n("span",null,"Consul namespace 사용시 Nomad의 서비스 등록")])],-1),r=n("h2",{id:"job의-consul-namespace-정의",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#job의-consul-namespace-정의"},[n("span",null,"Job의 Consul Namespace 정의")])],-1),d=n("p",null,[s("Consul Enterprise는 "),n("code",null,"Namespace"),s("가 있어서 Nomad로 Consul에 서비스 등록 시 특정 Namespace를 지정할 수 있음")],-1),v=n("p",null,"Job > Group > Consul",-1),k=n("div",{class:"language-hcl line-numbers-mode","data-ext":"hcl","data-title":"hcl"},[n("pre",{hcl:"",class:"language-hcl"},[n("code",null,[s("job "),n("span",{class:"token string"},'"frontback_job"'),s(),n("span",{class:"token punctuation"},"{"),s(`
  group `),n("span",{class:"token string"},'"backend_group_v1"'),s(),n("span",{class:"token punctuation"},"{"),s(`

    `),n("span",{class:"token property"},"count"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token number"},"1"),s(`

    `),n("span",{class:"token keyword"},"consul"),s(),n("span",{class:"token punctuation"},"{"),s(`
      `),n("span",{class:"token property"},"namespace"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"mynamespace"'),s(`
    `),n("span",{class:"token punctuation"},"}"),s(`

    `),n("span",{class:"token keyword"},"service"),s(),n("span",{class:"token punctuation"},"{"),s(`
      `),n("span",{class:"token property"},"name"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"backend"'),s(`
      `),n("span",{class:"token property"},"port"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"http"'),s(`

      `),n("span",{class:"token keyword"},"connect"),s(),n("span",{class:"token punctuation"},"{"),s(`
        `),n("span",{class:"token keyword"},"sidecar_service"),s(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"}"),s(`
      `),n("span",{class:"token punctuation"},"}"),s(`

      `),n("span",{class:"token keyword"},"check"),s(),n("span",{class:"token punctuation"},"{"),s(`
        `),n("span",{class:"token property"},"type"),s("     "),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"http"'),s(`
        `),n("span",{class:"token property"},"path"),s("     "),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"/"'),s(`
        `),n("span",{class:"token property"},"interval"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"5s"'),s(`
        `),n("span",{class:"token property"},"timeout"),s("  "),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"3s"'),s(`
      `),n("span",{class:"token punctuation"},"}"),s(`
    `),n("span",{class:"token punctuation"},"}"),s(`
`),n("span",{class:"token comment"},"# 생략"),s(`
`)])]),n("div",{class:"highlight-lines"},[n("br"),n("br"),n("br"),n("br"),n("br"),n("div",{class:"highlight-line"}," "),n("div",{class:"highlight-line"}," "),n("div",{class:"highlight-line"}," "),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br")]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),m=n("h2",{id:"service-mesh-upstream",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#service-mesh-upstream"},[n("span",null,"Service Mesh Upstream")])],-1),b=n("p",null,[s("해당 "),n("code",null,"group"),s("에 대한 글로벌 설정이기 때문에 Consul과 관련해서 구성되는 모든 설정은 해당 "),n("code",null,"Namespace"),s("를 기준으로 적용됨"),n("br"),s(" 예를 들어 "),n("code",null,"upstream"),s(" 구성을 하면")],-1),g=n("div",{class:"language-hcl line-numbers-mode","data-ext":"hcl","data-title":"hcl"},[n("pre",{hcl:"",class:"language-hcl"},[n("code",null,[s("job "),n("span",{class:"token string"},'"frontback_job"'),s(),n("span",{class:"token punctuation"},"{"),s(`
  group `),n("span",{class:"token string"},'"frontend_group"'),s(),n("span",{class:"token punctuation"},"{"),s(`
    `),n("span",{class:"token property"},"count"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token number"},"1"),s(`

    `),n("span",{class:"token keyword"},"consul"),s(),n("span",{class:"token punctuation"},"{"),s(`
      `),n("span",{class:"token property"},"namespace"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"mesh"'),s(`
    `),n("span",{class:"token punctuation"},"}"),s(`

    `),n("span",{class:"token keyword"},"service"),s(),n("span",{class:"token punctuation"},"{"),s(`
      `),n("span",{class:"token property"},"name"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"frontend"'),s(`
      `),n("span",{class:"token property"},"port"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"http"'),s(`

      `),n("span",{class:"token keyword"},"connect"),s(),n("span",{class:"token punctuation"},"{"),s(`
        `),n("span",{class:"token keyword"},"sidecar_service"),s(),n("span",{class:"token punctuation"},"{"),s(`
          `),n("span",{class:"token keyword"},"proxy"),s(),n("span",{class:"token punctuation"},"{"),s(`
            `),n("span",{class:"token keyword"},"upstreams"),s(),n("span",{class:"token punctuation"},"{"),s(`
              `),n("span",{class:"token property"},"destination_name"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"backend"'),s(`
              `),n("span",{class:"token property"},"local_bind_port"),s("  "),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token number"},"10000"),s(`
            `),n("span",{class:"token punctuation"},"}"),s(`
          `),n("span",{class:"token punctuation"},"}"),s(`
        `),n("span",{class:"token punctuation"},"}"),s(`
      `),n("span",{class:"token punctuation"},"}"),s(`
`),n("span",{class:"token comment"},"# 생략"),s(`
`)])]),n("div",{class:"highlight-lines"},[n("br"),n("br"),n("br"),n("br"),n("div",{class:"highlight-line"}," "),n("div",{class:"highlight-line"}," "),n("div",{class:"highlight-line"}," "),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("div",{class:"highlight-line"}," "),n("div",{class:"highlight-line"}," "),n("div",{class:"highlight-line"}," "),n("div",{class:"highlight-line"}," "),n("br"),n("br"),n("br"),n("br")]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),y=a(`<p>sidecar의 로그에서도 적용된 namespace로 리스너가 등록되는 로그(<code>namesapce/servicename</code>) 확인 가능</p><div class="language-text" data-ext="text" data-title="text"><pre class="language-text"><code>[2021-09-01 01:31:10.490][1][info][upstream] [source/common/upstream/cds_api_helper.cc:28] cds: add 3 cluster(s), remove 0 cluster(s)
...
</code></pre><div class="highlight-lines"><br><br><br><br><br><div class="highlight-line"> </div><br><br><br></div></div><h2 id="dns-쿼리" tabindex="-1"><a class="header-anchor" href="#dns-쿼리"><span>DNS 쿼리</span></a></h2>`,3),h={class:"hint-container warning"},q=n("p",{class:"hint-container-title"},"경고",-1),_=n("p",null,"주의할점은 DNS를 사용하는 경우, 예를들어 template 작성시 namespace가 추가되면 경로상 datacenter도 정의해줘야 인식하는 것으로 보임",-1),w=n("div",{class:"language-text","data-ext":"text","data-title":"text"},[n("pre",{class:"language-text"},[n("code",null,`[tag.]<service>.service.<namespace>.<datacenter>.<domain>
`)])],-1),f={href:"https://www.consul.io/docs/discovery/dns#namespaced-services",target:"_blank",rel:"noopener noreferrer"},x=n("p",null,[n("strong",null,"기존 템플릿")],-1),N=n("div",{class:"language-hcl line-numbers-mode","data-ext":"hcl","data-title":"hcl"},[n("pre",{hcl:"",class:"language-hcl"},[n("code",null,[n("span",{class:"token keyword"},"template"),s(),n("span",{class:"token punctuation"},"{"),s(`
...
EOF`),s(`
  ...
  `),n("span",{class:"token property"},"destination"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"local/haproxy.cfg"'),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("div",{class:"highlight-lines"},[n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("div",{class:"highlight-line"}," "),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br")]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),C=n("p",null,[n("strong",null,"Namespace 적용 템플릿")],-1),O=n("div",{class:"language-hcl line-numbers-mode","data-ext":"hcl","data-title":"hcl"},[n("pre",{hcl:"",class:"language-hcl"},[n("code",null,[n("span",{class:"token keyword"},"template"),s(),n("span",{class:"token punctuation"},"{"),s(`
  `),n("span",{class:"token property"},"data"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token heredoc string"},`<<EOF
defaults
   mode http
...
EOF`),s(`
  ...
  `),n("span",{class:"token property"},"destination"),s(),n("span",{class:"token punctuation"},"="),s(),n("span",{class:"token string"},'"local/haproxy.cfg"'),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("div",{class:"highlight-lines"},[n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("div",{class:"highlight-line"}," "),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br")]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),D=a(`<details class="hint-container details"><summary>Full Example (mesh.nomad)</summary><div class="language-hcl line-numbers-mode" data-ext="hcl" data-title="hcl"><pre class="language-hcl"><code><span class="token comment"># nomad namespace apply -description &quot;ServiceMesh Sample&quot; mesh</span>
