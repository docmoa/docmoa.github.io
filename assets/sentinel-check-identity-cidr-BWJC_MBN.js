import{O as e,f as t,u as n}from"./runtime-core.esm-bundler-DwmdDY9i.js";import{t as r}from"./plugin-vue_export-helper-BDNMzG2s.js";var i=JSON.parse(`{"path":"/04-HashiCorp/06-Vault/04-UseCase/sentinel-check-identity-cidr.html","title":"Sentinel - (Identity & CIDR)","lang":"ko-KR","frontmatter":{"description":"Sentinel을 사용하여 identity 조건에 cidr 검사","tag":["vault","sentinel","cidr","enterprise"],"head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Sentinel - (Identity & CIDR)\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-09-18T13:12:54.000Z\\",\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://docmoa.github.io/04-HashiCorp/06-Vault/04-UseCase/sentinel-check-identity-cidr.html"}],["meta",{"property":"og:site_name","content":"docmoa"}],["meta",{"property":"og:title","content":"Sentinel - (Identity & CIDR)"}],["meta",{"property":"og:description","content":"Sentinel을 사용하여 identity 조건에 cidr 검사"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"ko-KR"}],["meta",{"property":"og:updated_time","content":"2023-09-18T13:12:54.000Z"}],["meta",{"property":"article:tag","content":"enterprise"}],["meta",{"property":"article:tag","content":"cidr"}],["meta",{"property":"article:tag","content":"sentinel"}],["meta",{"property":"article:tag","content":"vault"}],["meta",{"property":"article:modified_time","content":"2023-09-18T13:12:54.000Z"}]]},"git":{"createdTime":1668567247000,"updatedTime":1695042774000,"contributors":[{"name":"Great-Stone","username":"Great-Stone","email":"hahohh@gmail.com","commits":3,"url":"https://github.com/Great-Stone"}]},"readingTime":{"minutes":6.58,"words":395},"filePathRelative":"04-HashiCorp/06-Vault/04-UseCase/sentinel-check-identity-cidr.md","excerpt":"\\n<blockquote>\\n<p>Enterprise 기능</p>\\n</blockquote>\\n<p>Token Role에 <code>bound_cidr</code>을 적용하거나 여타 인증(AppRole, Userpass 등)에 허용하는 cidr을 적용하는 경우 다시 Token을 발급하거나 인증받지 않는한은 cidr을 기반으로한 차단을 동적으로 적용할 수 없다.</p>\\n<p>이경우 Sentinel을 사용하여 동적인 정책을 적용할 수 있다. Sentinel은 ACL방식의 기존 <code>Policy</code>와는 달리 Path가 아닌 다른 검증 조건을 추가할 수 있다.</p>"}`),a={name:`sentinel-check-identity-cidr.md`};function o(r,i,a,o,s,c){return e(),n(`div`,null,[...i[0]||=[t(`<h1 id="sentinel-identity-cidr" tabindex="-1"><a class="header-anchor" href="#sentinel-identity-cidr"><span>Sentinel - (Identity &amp; CIDR)</span></a></h1><blockquote><p>Enterprise 기능</p></blockquote><p>Token Role에 <code>bound_cidr</code>을 적용하거나 여타 인증(AppRole, Userpass 등)에 허용하는 cidr을 적용하는 경우 다시 Token을 발급하거나 인증받지 않는한은 cidr을 기반으로한 차단을 동적으로 적용할 수 없다.</p><p>이경우 Sentinel을 사용하여 동적인 정책을 적용할 수 있다. Sentinel은 ACL방식의 기존 <code>Policy</code>와는 달리 Path가 아닌 다른 검증 조건을 추가할 수 있다.</p><ul><li><p>예제 (GitHub) : <a href="https://github.com/hashicorp/vault-guides/blob/master/governance/sentinel/README.md" target="_blank" rel="noopener noreferrer">https://github.com/hashicorp/vault-guides/blob/master/governance/sentinel/README.md</a></p></li><li><p>엔터프라이즈 Trial 신청 (30일) : <a href="https://www.hashicorp.com/products/vault/trial" target="_blank" rel="noopener noreferrer">https://www.hashicorp.com/products/vault/trial</a></p></li></ul><h2 id="테스트-사용자-생성" tabindex="-1"><a class="header-anchor" href="#테스트-사용자-생성"><span>테스트 사용자 생성</span></a></h2><p>Sentinel 적용을 확인하기 위해 모든 권한이 있는 기존 <code>Policy</code> 방식의 정책을 생성한다.</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">vault policy <span class="token function">write</span> super-user - <span class="token operator">&lt;&lt;</span> <span class="token string">EOF</span>
<span class="line">path &quot;*&quot; {</span>
<span class="line">capabilities = [&quot;create&quot;, &quot;read&quot;, &quot;update&quot;, &quot;delete&quot;, &quot;list&quot;, &quot;sudo&quot;]</span>
<span class="line">}</span>
<span class="line">EOF</span></span>
<span class="line"></span></code></pre></div><p>생성한 정책고 앞으로 생성할 Sentinel 정책이 포함된 사용자를 생성한다.</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">vault <span class="token function">write</span> auth/userpass/users/admin <span class="token assign-left variable">password</span><span class="token operator">=</span>password <span class="token assign-left variable">policies</span><span class="token operator">=</span><span class="token string">&quot;super-user, test-rgp&quot;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="sentinel-생성" tabindex="-1"><a class="header-anchor" href="#sentinel-생성"><span>Sentinel 생성</span></a></h2><p>다음과 같이 적용할 <code>identity-cidr-check.sentinel</code> 파일을 생성한다. (확장자는 다른 확장자를 사용해도 무방하다. e.g. hcl)</p><div class="language-hcl line-numbers-mode has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="hcl" style="--vp-collapsed-lines:20;"><pre><code class="language-hcl"><span class="line">import <span class="token string">&quot;sockaddr&quot;</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><ul><li>precond : main 규칙에서 조건으로 부여할 규칙을 정의한다. <ul><li><code>identity.entity.id</code>로 검증할 아이디 내용에는 앞서 확인한 <code>admin</code>과 <code>rgp</code> 사용자의 <code>entity_id</code>를 조건에 넣는다.</li><li><code>admin</code> 사용자의 경우 우선 주석처리하여 진행한다.</li></ul></li><li>cidrcheck : cidr을 검증할 규칙을 정의한다.</li></ul><p>적용하는 방식은 다음과 같다.</p><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">POLICY=$(base64 identity-cidr-check.sentinel)</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h2 id="sentinel-검증" tabindex="-1"><a class="header-anchor" href="#sentinel-검증"><span>Sentinel 검증</span></a></h2><p><code>admin</code> 사용자로 로그인하여 kv를 생성하고 값을 넣는다.</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ vault login <span class="token parameter variable">-method</span> userpass <span class="token assign-left variable">username</span><span class="token operator">=</span>admin <span class="token assign-left variable">password</span><span class="token operator">=</span>password</span>
...
<span class="line"></span></code></pre></div><p><code>rgp</code> 사용자로 로그인하여 kv를 조회해본다.</p><div class="language-bash line-numbers-mode has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="sh" style="--vp-collapsed-lines:20;"><pre><code class="language-bash"><span class="line">$ vault login <span class="token parameter variable">-method</span> userpass <span class="token assign-left variable">username</span><span class="token operator">=</span>rgp <span class="token assign-left variable">password</span><span class="token operator">=</span>password</span>
<span class="line">$ vault kv get kv/hello</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><p>cidrcheck 에서 검증하는 cidr에 속하지 못하면 요청 단계에서 권한이 없음을 표기한다.</p><h2 id="identity-동적으로-변경하기" tabindex="-1"><a class="header-anchor" href="#identity-동적으로-변경하기"><span>identity 동적으로 변경하기</span></a></h2><p>앞서 작성한 sentinel 규칙에서 <code>admin</code> 사용자의 <code>identity.id</code>의 주석을 해제하여 다시 적용해 본다.</p><div class="language-hcl line-numbers-mode" data-highlighter="prismjs" data-ext="hcl"><pre><code class="language-hcl"><span class="line">...생략...</span>
<span class="line"></span>
<span class="line"><span class="token property">precond</span> <span class="token punctuation">=</span> <span class="token keyword">rule</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token comment"># admin user</span></span>
<span class="line">    identity.entity.id is <span class="token string">&quot;17230158-d0ad-dd6d-b749-3c7de9e2b4cf&quot;</span> or</span>
<span class="line">    <span class="token comment"># rgp user</span></span>
<span class="line">    identity.entity.id is <span class="token string">&quot;31cc28c0-9fd0-82b3-a70d-0eef741c5349&quot;</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span>
<span class="line">...생략...</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>admin</code> 사용자로 로그인하여 kv를 조회해도 cidr 조건에 맞지 않으면 동일한 오류가 발생한다.</p><h2 id="cidr-동적으로-변경하기" tabindex="-1"><a class="header-anchor" href="#cidr-동적으로-변경하기"><span>cidr 동적으로 변경하기</span></a></h2><p>허용하는 cidr을 추가해본다. 로컬에서 테스트하는 경우 <code>127.0.0.1</code>이 해당 ip가 될 수 있다.</p><div class="language-hcl" data-highlighter="prismjs" data-ext="hcl"><pre><code class="language-hcl"><span class="line">...생략...</span>
<span class="line"></span>
<span class="line"><span class="token property">cidrcheck</span> <span class="token punctuation">=</span> <span class="token keyword">rule</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token comment">## Loopback</span></span>
...
<span class="line"></span>
<span class="line">...생략...</span>
<span class="line"></span></code></pre></div><p>적용 후 <code>admin</code> 사용자와 <code>rgp</code> 사용자 모두 정상적으로 kv의 값을 확인할 수 있다.</p>`,33)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};