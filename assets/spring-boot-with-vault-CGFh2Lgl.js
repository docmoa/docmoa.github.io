import{O as e,f as t,u as n}from"./runtime-core.esm-bundler-DwmdDY9i.js";import{t as r}from"./plugin-vue_export-helper-BDNMzG2s.js";var i=JSON.parse(`{"path":"/04-HashiCorp/06-Vault/04-UseCase/spring-boot-with-vault.html","title":"Vault로 Spring Boot 구성관리 aws-auth Version","lang":"ko-KR","frontmatter":{"head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Vault로 Spring Boot 구성관리 aws-auth Version\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-09-04T14:39:50.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"unghee\\"}]}"],["meta",{"property":"og:url","content":"https://docmoa.github.io/04-HashiCorp/06-Vault/04-UseCase/spring-boot-with-vault.html"}],["meta",{"property":"og:site_name","content":"docmoa"}],["meta",{"property":"og:title","content":"Vault로 Spring Boot 구성관리 aws-auth Version"}],["meta",{"property":"og:description","content":"Vault로 Spring Boot 구성관리 aws-auth Version token, app-role로 관리: docmoa Spring boot에서는 Token, App-role을 제외하고 aws-auth를 통해서도 Secret을 주입 할 수 있습니다. aws-auth에서는 다음의 두 기능을 지원합니다. AWS IA..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"ko-KR"}],["meta",{"property":"og:updated_time","content":"2024-09-04T14:39:50.000Z"}],["meta",{"property":"article:author","content":"unghee"}],["meta",{"property":"article:tag","content":"aws-auth"}],["meta",{"property":"article:tag","content":"spring"}],["meta",{"property":"article:tag","content":"java"}],["meta",{"property":"article:tag","content":"vault"}],["meta",{"property":"article:modified_time","content":"2024-09-04T14:39:50.000Z"}],["meta",{"name":"Spring Boot Vault aws-auth Version","content":"Spring Boot에 구성관리로 Vault 사용 aws-auth Version"}]],"author":"unghee","tag":["vault","java","spring","aws-auth"],"description":"Vault로 Spring Boot 구성관리 aws-auth Version token, app-role로 관리: docmoa Spring boot에서는 Token, App-role을 제외하고 aws-auth를 통해서도 Secret을 주입 할 수 있습니다. aws-auth에서는 다음의 두 기능을 지원합니다. AWS IA..."},"git":{"createdTime":1725444002000,"updatedTime":1725460790000,"contributors":[{"name":"ung","username":"ung","email":"ung@mz.co.kr","commits":2,"url":"https://github.com/ung"},{"name":"Great-Stone","username":"Great-Stone","email":"hahohh@gmail.com","commits":1,"url":"https://github.com/Great-Stone"}]},"readingTime":{"minutes":10.33,"words":620},"filePathRelative":"04-HashiCorp/06-Vault/04-UseCase/spring-boot-with-vault.md","excerpt":"\\n<blockquote>\\n<p>token, app-role로 관리: <a href=\\"https://docmoa.github.io/04-HashiCorp/06-Vault/04-UseCase/spring-boot.html\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">docmoa</a></p>\\n</blockquote>\\n<p>Spring boot에서는 Token, App-role을 제외하고 aws-auth를 통해서도 Secret을 주입 할 수 있습니다.<br>\\naws-auth에서는 다음의 두 기능을 지원합니다.</p>","copyright":{"author":"unghee"},"autoDesc":true}`),a={name:`spring-boot-with-vault.md`};function o(r,i,a,o,s,c){return e(),n(`div`,null,[...i[0]||=[t(`<h1 id="vault로-spring-boot-구성관리-aws-auth-version" tabindex="-1"><a class="header-anchor" href="#vault로-spring-boot-구성관리-aws-auth-version"><span>Vault로 Spring Boot 구성관리 aws-auth Version</span></a></h1><blockquote><p>token, app-role로 관리: <a href="https://docmoa.github.io/04-HashiCorp/06-Vault/04-UseCase/spring-boot.html" target="_blank" rel="noopener noreferrer">docmoa</a></p></blockquote><p>Spring boot에서는 Token, App-role을 제외하고 aws-auth를 통해서도 Secret을 주입 할 수 있습니다.<br> aws-auth에서는 다음의 두 기능을 지원합니다.</p><ul><li>AWS IAM <ul><li>EC2에 적용되는 AWS IAM Name을 기반으로 인증, 인가를 받고 Application이 <strong>실행</strong> 될 때 Secret을 주입합니다.</li></ul></li><li>EC2 Tag <ul><li>EC2에 적용되는 AWS Tag Name의 Value 기반으로 인증, 인가를 받고 Application이 <strong>실행</strong> 될 때 Secret을 주입합니다.</li></ul></li></ul><p>두 기능에 대한 장점은 Spring boot의 공통 영역인 application.yaml의 token이나 app-role의 값이 노출되는 것을 방지할 수 있고, ci/cd 단계 또한 치환하는 과정이 줄어듭니다.</p><p>자세한 기능들은 아래의 설정을 보면서 알아보겠습니다.</p><ol><li>Vault Secret 설정</li></ol><ul><li>Vault Secret은 아래와 같이 설정했습니다.</li><li>여기서 생성하는 <strong>Secret Engine</strong>명과 <strong>KV Path</strong>명을 기준으로 자동화를 쉽게 할 수 있습니다.</li></ul><div class="language-hcl has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="hcl" style="--vp-collapsed-lines:20;"><pre><code class="language-hcl"><span class="line"><span class="token comment"># Vault Secret engine의 이름을 spring* application 이름과 동일하게 맞추면 조금 더 설정이 쉽습니다.</span></span>
...
<span class="line">  <span class="token punctuation">}</span>)</span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="collapsed-lines"></div></div><ol start="2"><li>Vault AWS-Auth 설정 (IAM, EC2-Tag)</li></ol><ul><li>aws_spring_boot_iam <ul><li>iam 기준으로 인증하는 aws-auth role입니다.</li><li>미리 생성한 aws iam을 &quot;bound_iam_role_arns&quot;에 명시합니다.</li></ul></li><li>aws_spring_boot_ec2 <ul><li>ec2 tag 기준으로 인증하는 aws-auth role입니다.</li><li>ec2에 tag key로 &quot;role_tag&quot; value로는 output인 &quot;vault_ec2_tag&quot;에 값을 입력합니다.</li></ul></li></ul><div class="language-hcl has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="hcl" style="--vp-collapsed-lines:20;"><pre><code class="language-hcl"><span class="line"><span class="token keyword">resource <span class="token type variable">&quot;vault_policy&quot;</span></span> <span class="token string">&quot;policy_spring_boot&quot;</span> <span class="token punctuation">{</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="collapsed-lines"></div></div><ol start="3"><li>공통영역 (AWS-IAM)</li></ol><ul><li>application.yaml 파일입니다.</li><li>아래와 같이 datasource와 aws 접근 정보를 생략한다고 해도 제 데이터는 Vault Secret Engine Path의 key명 기준으로 Value값을 치환합니다.</li><li>ex)s3 접근하는 accesskey는 &quot;cloud.aws.s3.accessKey&quot;의 Value 값인 &quot;aws_access&quot;를 치환합니다.</li></ul><div class="language-yaml has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="yml" style="--vp-collapsed-lines:20;"><pre><code class="language-yaml"><span class="line"><span class="token key atrule">spring</span><span class="token punctuation">:</span></span>
...
<span class="line"></span></code></pre><div class="collapsed-lines"></div></div><ol start="4"><li>공통영역 (AWS-EC2-Tag)</li></ol><ul><li>application.yaml 파일입니다.</li><li>아래와 같이 datasource와 aws 접근 정보를 생략한다고 해도 제 데이터는 Vault Secret Engine Path의 key명 기준으로 Value값을 치환합니다.</li><li>ex)s3 접근하는 accesskey는 &quot;cloud.aws.s3.accessKey&quot;의 Value 값인 &quot;aws_access&quot;를 치환합니다.</li></ul><div class="hint-container warning"><p class="hint-container-title">경고</p><p>nonce는 application의 인식값입니다. 지정하지 않고 해당 ec2에서 실행된다면 다음의 명령어로 확인하여야 합니다.</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment">#vault read auth/ung/identity-accesslist/instance-id</span></span>
...
<span class="line"></span></code></pre></div></div><div class="language-yaml has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="yml" style="--vp-collapsed-lines:20;"><pre><code class="language-yaml"><span class="line"><span class="token key atrule">spring</span><span class="token punctuation">:</span></span>
<span class="line">  <span class="token key atrule">thymeleaf</span><span class="token punctuation">:</span></span>
<span class="line">    <span class="token key atrule">check-template-location</span><span class="token punctuation">:</span> <span class="token boolean important">true</span></span>
<span class="line">    <span class="token key atrule">prefix</span><span class="token punctuation">:</span> classpath<span class="token punctuation">:</span>/templates/</span>
<span class="line">    <span class="token key atrule">suffix</span><span class="token punctuation">:</span> .html</span>
...
<span class="line"></span></code></pre><div class="collapsed-lines"></div></div><ol start="5"><li>적용 확인</li></ol><ul><li><p>4번까지 설정을 하였다면 사실 EC2의 적용하는 것은 어렵지 않을 것입니다.</p></li><li><p>먼저 IAM 적용입니다. 배포하려는 ec2에 IAM을 attch하면 됩니다.<br><img src="/assets/aws-auth-2-ClPQVFqZ.png" alt="" loading="lazy"></p></li><li><p>다음으로는 ec2 tag입니다. 배포하려는 ec2에 tag에는 &quot;svc_type&quot; value에는 vault_ec2_tag의 output값을 넣어줍니다.<br><img src="/assets/aws-auth-1-DllmqSts.png" alt="" loading="lazy"></p></li><li><p>ec2에서는 아래와 같이 결과를 확인할 수 있습니다.<br><img src="/assets/aws-auth-3-CBGrmdM5.png" alt="" loading="lazy"></p></li></ul>`,21)]])}var s=r(a,[[`render`,o]]);export{i as _pageData,s as default};