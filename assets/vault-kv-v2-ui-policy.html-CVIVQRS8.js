import{_ as o}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as u,o as c,c as d,a as p,w as n,e as i,d as s,b as a}from"./app-DwRVeH7t.js";const r={},v=i(`<h1 id="kv-v2-ui-policy" tabindex="-1"><a class="header-anchor" href="#kv-v2-ui-policy"><span>kv-v2 UI Policy</span></a></h1><blockquote><p>사용자별 UI 접근에 대한 설정을 Kv-v2를 예로 확인</p></blockquote><h2 id="policy-구성" tabindex="-1"><a class="header-anchor" href="#policy-구성"><span>Policy 구성</span></a></h2><p>UI 접근을 위해서는 <code>metadata</code>에 대한 권한 추가가 필요함</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ vault policy <span class="token function">write</span> ui-kv-policy - <span class="token operator">&lt;&lt;</span> <span class="token string">EOF
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="인증-생성" tabindex="-1"><a class="header-anchor" href="#인증-생성"><span>인증 생성</span></a></h2><p>생성한 Policy 기반으로 인증 생성</p>`,7),m=a("div",{class:"language-bash","data-ext":"sh","data-title":"sh"},[a("pre",{class:"language-bash"},[a("code",null,[s("$ vault "),a("span",{class:"token function"},"write"),s(" auth/userpass/users/userid "),a("span",{class:"token assign-left variable"},"password"),a("span",{class:"token operator"},"="),s("password "),a("span",{class:"token assign-left variable"},"policies"),a("span",{class:"token operator"},"="),s(`ui-kv-policy
`)])])],-1),b=a("div",{class:"language-bash","data-ext":"sh","data-title":"sh"},[a("pre",{bash:"",class:"language-bash"},[a("code",null,[s("vault token create "),a("span",{class:"token parameter variable"},"-policy"),a("span",{class:"token operator"},"="),s(`ui-kv-policy
`)])]),a("div",{class:"highlight-lines"},[a("br")])],-1),h=i(`<h2 id="조회-확인" tabindex="-1"><a class="header-anchor" href="#조회-확인"><span>조회 확인</span></a></h2><p>생성한 인증의 <code>Token</code>을 사용하여 데이터가 조회됨을 확인</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token function">curl</span>  <span class="token parameter variable">--request</span> GET <span class="token parameter variable">--header</span> <span class="token string">&quot;X-Vault-Token: s.FqFMzKL8ExjJeBrq79Jjh1eB&quot;</span> http://172.28.128.11:8200/v1/kv-v2/data/path/userid <span class="token operator">|</span> jq <span class="token builtin class-name">.</span>
