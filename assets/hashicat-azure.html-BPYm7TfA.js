import{_ as o}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as p,c as r,b as n,d as s,a as e,e as t}from"./app-DwRVeH7t.js";const l={},c=n("h1",{id:"intro-to-terraform-on-azure",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#intro-to-terraform-on-azure"},[n("span",null,"Intro to Terraform on Azure")])],-1),u={href:"https://hashicorp.github.io/field-workshops-terraform/slides/azure/terraform-oss/#1",target:"_blank",rel:"noopener noreferrer"},d={href:"https://github.com/hashicorp/hashicat-azure",target:"_blank",rel:"noopener noreferrer"},v=t(`<figure><img src="https://media.licdn.com/dms/image/C5612AQGhxYMwcjsNSQ/article-cover_image-shrink_600_2000/0/1643170479486?e=2147483647&amp;v=beta&amp;t=yHuifr0mLn3lU1D41ZJ_HvhJ6uDqcfkbxp2GjyRcdYo" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h2 id="azure-자격증명-설정" tabindex="-1"><a class="header-anchor" href="#azure-자격증명-설정"><span>Azure 자격증명 설정</span></a></h2><blockquote><p>자격증명 설정을 위한 상세 설명은 생략합니다.</p></blockquote><p>Terraform에서는 해당 CSP에서 리소스를 배포하기 위해 자격증명이 필요합니다. 자신의 Azure 구독정보를 연동하기 위해 credentials를 설정합니다.</p><ul><li>ARM_SUBSCRIPTION_ID</li><li>ARM_CLIENT_ID</li><li>ARM_CLIENT_SECRET</li><li>ARM_TENANT_ID</li><li>ARM_ENVIRONMENT (옵션)</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">env</span> <span class="token operator">|</span> <span class="token function">grep</span> ARM
...
</code></pre></div><h2 id="실습-시나리오1-azurerm-resource-group-생성" tabindex="-1"><a class="header-anchor" href="#실습-시나리오1-azurerm-resource-group-생성"><span>실습) 시나리오1. azurerm_resource_group 생성</span></a></h2><p>Azure에서는 기본적으로 리소스를 관리하기 위해 리소스 그룹을 생성해야 합니다. 이번 사니리오에서는 리소스 그룹을 생성해보겠습니다.</p><h3 id="hcl-구성파일" tabindex="-1"><a class="header-anchor" href="#hcl-구성파일"><span>HCL 구성파일</span></a></h3>`,9),k={href:"http://main.tf",target:"_blank",rel:"noopener noreferrer"},m=t(`<p>가장 기본이 되는 <code>main.tf</code> 코드의 구조는 다음과 같습니다.</p><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>terraform <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),g={href:"http://variables.tf",target:"_blank",rel:"noopener noreferrer"},b=t(`<p>해당 샘플코드에서는 <code>prefix</code> 라는 변수만 필요하므로 다음과 같이 선언합니다.</p><div class="language-ruby" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>variable <span class="token string-literal"><span class="token string">&quot;prefix&quot;</span></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><ul><li>terraform.tfvars</li></ul><p>앞서 <code>variables.tf</code> 에서 <code>default = &quot;unknown&quot;</code> 으로 선언하였습니다. 이때, 사용자화된 값으로 대체하기 위해서 변수의 우선순위를 활용하여 덮어쓸 수 있습니다.</p><p>필자는 <code>terraform.tfvars</code> 파일을 사용하여 덮어쓰는 방식을 사용해보겠습니다.</p><div class="language-ruby" data-ext="rb" data-title="rb"><pre class="language-ruby"><code><span class="token comment"># prefix에 자신의 이름을 작성하세요</span>
prefix <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;hyungwook&quot;</span></span>
</code></pre></div><h3 id="테라폼-초기화-init" tabindex="-1"><a class="header-anchor" href="#테라폼-초기화-init"><span>테라폼 초기화(init)</span></a></h3><ul><li><code>terraform init</code> 명령을 통해 azurerm 프로바이더를 사용하기 위해 초기화를 진행합니다.</li></ul><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>terraform init
</code></pre></div><p>초기화 명령 이후에 azurerm 에서 사용할 데이터가 <code>.terraform</code> 디렉토리 하위에 생성되었는지 확인합니다.</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">ls</span> .terraform/providers/registry.terraform.io/hashicorp
azurerm
</code></pre></div><h3 id="테라폼-계획-배포-plan-apply" tabindex="-1"><a class="header-anchor" href="#테라폼-계획-배포-plan-apply"><span>테라폼 계획 &amp; 배포(plan &amp; apply)</span></a></h3><ul><li><code>terraform plan</code> 명령을 통해 배포되기 전 계획을 확인합니다. 해당 실습에서는 최초 배포이므로 한 개의 리소스가 create 됩니다.</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>terraform plan
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>terraform apply</code> 명령을 통해 실제 리소스를 배포합니다.</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>terraform apply
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="실습-시나리오-2-vnet-생성" tabindex="-1"><a class="header-anchor" href="#실습-시나리오-2-vnet-생성"><span>실습) 시나리오 2. vnet 생성</span></a></h2><p>시나리오 1에서 생성한 리소스 그룹에 vnet을 추가합니다.</p><h3 id="hcl-구성파일-1" tabindex="-1"><a class="header-anchor" href="#hcl-구성파일-1"><span>HCL 구성파일</span></a></h3>`,19),_={href:"http://main.tf",target:"_blank",rel:"noopener noreferrer"},h=t(`<p>앞서 사용했던 <code>main.tf</code> 파일에 다음과 같이 추가할 <code>azurerm_virtual_network</code> 절을 추가합니다.</p><div class="language-ruby" data-ext="rb" data-title="rb"><pre class="language-ruby"><code><span class="token comment"># 생략</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,2),q={href:"http://variables.tf",target:"_blank",rel:"noopener noreferrer"},f=n("ul",null,[n("li",null,[n("code",null,"prefix"),s(" : 리소스의 가장 앞에 선언할 변수명")]),n("li",null,[n("code",null,"address_space"),s(" : 기본 CIDR 정의")])],-1),y=t(`<div class="language-ruby" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>variable <span class="token string-literal"><span class="token string">&quot;prefix&quot;</span></span> <span class="token punctuation">{</span>
  description <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;This prefix will be included in the name of most resources.&quot;</span></span>
  default <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;unknown&quot;</span></span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="테라폼-계획-배포-plan-apply-1" tabindex="-1"><a class="header-anchor" href="#테라폼-계획-배포-plan-apply-1"><span>테라폼 계획 &amp; 배포(plan &amp; apply)</span></a></h3><p><code>azurerm_virtual_network</code> 리소스가 추가로 생성되는 것을 확인합니다.</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 생략</span>
Terraform used the selected providers to generate the following execution plan. Resource actions are indicated with the following symbols:
  + create
...
Terraform will perform the following actions:
  ...
  + resource <span class="token string">&quot;azurerm_virtual_network&quot;</span> <span class="token string">&quot;vnet&quot;</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="실습-시나리오-3-subnet-security-group-생성" tabindex="-1"><a class="header-anchor" href="#실습-시나리오-3-subnet-security-group-생성"><span>실습) 시나리오 3. Subnet &amp; security group 생성</span></a></h2><p>이번 시나리오에서는 vnet 내부에 subnet과 security group을 추가로 생성해보겠습니다.</p><h3 id="hcl-구성파일-2" tabindex="-1"><a class="header-anchor" href="#hcl-구성파일-2"><span>HCL 구성파일</span></a></h3>`,7),w={href:"http://main.tf",target:"_blank",rel:"noopener noreferrer"},x=n("ul",null,[n("li",null,[n("code",null,"azurerm_subnet")]),n("li",null,[n("code",null,"azurerm_network_security_group")])],-1),z=t(`<div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code><span class="token comment"># 생략</span>
...
resource <span class="token string-literal"><span class="token string">&quot;azurerm_network_security_group&quot;</span></span> <span class="token string-literal"><span class="token string">&quot;catapp-sg&quot;</span></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),T={href:"http://variables.tf",target:"_blank",rel:"noopener noreferrer"},I=n("code",null,"subnet_prerix",-1),A=n("ul",null,[n("li",null,[n("code",null,"prefix")]),n("li",null,[n("code",null,"address_space")]),n("li",null,[n("strong",null,[n("code",null,"subnet_prefix")])])],-1),C=t(`<div class="language-ruby" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>variable <span class="token string-literal"><span class="token string">&quot;subnet_prefix&quot;</span></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="테라폼-계획-배포-plan-apply-2" tabindex="-1"><a class="header-anchor" href="#테라폼-계획-배포-plan-apply-2"><span>테라폼 계획 &amp; 배포(plan &amp; apply)</span></a></h3><p>다음 두 리소스가 추가적으로 생성되는 것을 확인합니다.</p><ul><li>azurerm_network_security_group.catapp-sg</li><li>azurerm_subnet.subnet</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#(생략)</span>
Terraform will perform the following actions:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="실습-시나리오-4-hashicat-웹-애플리케이션-배포" tabindex="-1"><a class="header-anchor" href="#실습-시나리오-4-hashicat-웹-애플리케이션-배포"><span>실습) 시나리오 4. hashicat 웹 애플리케이션 배포</span></a></h2>`,6),S={href:"https://github.com/hashicorp/hashicat-azure",target:"_blank",rel:"noopener noreferrer"},H=n("p",null,"이번 시나리오는 실제 VM 인스턴스에 초기화 스크립트를 사용하여 웹 애플리케이션을 배포해보도록 하겠습니다.",-1),R=n("h3",{id:"hcl-구성파일-3",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#hcl-구성파일-3"},[n("span",null,"HCL 구성파일")])],-1),N={href:"http://main.tf",target:"_blank",rel:"noopener noreferrer"},E=t("<ul><li><code>azurerm_network_interface</code> : Network Interface 생성</li><li><code>azurerm_network_interface_security_group_association</code> : Network Interface에 Security Group 할당</li><li><code>azurerm_public_ip</code> : 가상머신에 접속하기 위한 Public IP</li><li><code>azurerm_virtual_machine</code> : 가상머신</li><li><code>null_resource</code> : 가상머신 배포 후 <code>provisioner</code> 를 통해 웹 서비스 설치를 위해 사용</li></ul>",1),L=t(`<div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>terraform <span class="token punctuation">{</span>
  required_providers <span class="token punctuation">{</span>
    azurerm <span class="token operator">=</span> <span class="token punctuation">{</span>
      source  <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;hashicorp/azurerm&quot;</span></span>
      version <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;=2.60.0&quot;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),$={href:"http://variables.tf",target:"_blank",rel:"noopener noreferrer"},D=n("ul",null,[n("li",null,"설명생략")],-1),P=t(`<div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>variable <span class="token string-literal"><span class="token string">&quot;prefix&quot;</span></span> <span class="token punctuation">{</span>
  description <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;This prefix will be included in the name of most resources.&quot;</span></span>
  default <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;unknown&quot;</span></span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="테라폼-계획-배포-plan-apply-3" tabindex="-1"><a class="header-anchor" href="#테라폼-계획-배포-plan-apply-3"><span>테라폼 계획 &amp; 배포(plan &amp; apply)</span></a></h3><p><code>main.tf</code>에서 추가했던 각종 리소스가 추가적으로 배포되는 것을 확인합니다.<br> 해당 시나리오에서는 가상머신 생성 후 <code>null_resource</code> 리소스를 통해 아파치 웹 서버를 설치하는 과정이 포함되어 있으므로 3~5분정도 소요됩니다.</p><h3 id="결과-확인-output" tabindex="-1"><a class="header-anchor" href="#결과-확인-output"><span>결과 확인 : output</span></a></h3><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 생략</span>
