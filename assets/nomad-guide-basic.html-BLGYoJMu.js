import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o,c as p,b as n,d as s,a as e,e as t}from"./app-DwRVeH7t.js";const c={},r=n("h1",{id:"nomad-guide-basic",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nomad-guide-basic"},[n("span",null,"Nomad Guide - Basic")])],-1),u=n("h2",{id:"download",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#download"},[n("span",null,"Download")])],-1),d={href:"https://releases.hashicorp.com/nomad",target:"_blank",rel:"noopener noreferrer"},v=n("li",null,"Version : 1.3.x",-1),m=n("li",null,[s("Platform 선택 "),n("ul",null,[n("li",null,"darwin(= MAC)"),n("li",null,"Linux"),n("li",null,"Windows")])],-1),k=t(`<h2 id="on-linux" tabindex="-1"><a class="header-anchor" href="#on-linux"><span>on Linux</span></a></h2><h3 id="구성-샘플" tabindex="-1"><a class="header-anchor" href="#구성-샘플"><span>구성 샘플</span></a></h3><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>└── hashicorp
    └── nomad
         ├── config
         └── data
</code></pre></div><ul><li>Donwload 받은 압축을 해제하고 기존 <code>$PATH</code> 위치에 복사 하거나 등록 <ul><li>e.g. utuntu : /usr/local/bin</li><li>e.g. centos : /usr/bin</li></ul></li></ul><h3 id="server-config" tabindex="-1"><a class="header-anchor" href="#server-config"><span>Server Config</span></a></h3><p>&lt;/hashicorp/nomad/config/nomad.hcl&gt;</p><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>datacenter <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;dc1&quot;</span></span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>advertise 에 지정된 http, rpc, serf 의 IP는 직접 IP를 입력하는 것도 가능</li><li>go-discover 형태인 구문을 활용하면 인터페이스 이름을 넣어서 자동 IP 입력 가능<div class="language-text" data-ext="text" data-title="text"><pre class="language-text"><code>{{ GetInterfaceIP \\&quot;eth1\\&quot; }}
</code></pre></div></li></ul><h3 id="client-config" tabindex="-1"><a class="header-anchor" href="#client-config"><span>Client Config</span></a></h3><p><code>retry_join</code>에 Server의 주소 꼭 넣기!</p><p>&lt;/hashicorp/nomad/config/nomad.hcl&gt;</p><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>datacenter <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;dc1&quot;</span></span>
data_dir <span class="token operator">=</span> <span class="token string-literal"><span class="token string">&quot;/hashicorp/nomad/data&quot;</span></span>
...
client <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="systemctl-서비스-등록" tabindex="-1"><a class="header-anchor" href="#systemctl-서비스-등록"><span>Systemctl 서비스 등록</span></a></h3>`,13),b={href:"https://learn.hashicorp.com/tutorials/nomad/production-deployment-guide-vm-with-consul",target:"_blank",rel:"noopener noreferrer"},g=t(`<div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">touch</span> /etc/systemd/system/nomad.service
</code></pre></div><ul><li><code>ExecStart</code>의 nomad 바이너리 경로에 주의!!!</li><li><code>ExecStart</code>의 <code>-config</code> 에 앞서 작성한 config 파일 디렉토리 경로 맞추기!!!</li><li>서버의 경우 User/Group을 일반 사용자로 구성</li><li>클라이언트(워커 노드)는 User/Group을 root로 구성</li></ul><div class="language-ini line-numbers-mode" data-ext="ini" data-title="ini"><pre class="language-ini"><code><span class="token section"><span class="token punctuation">[</span><span class="token section-name selector">Unit</span><span class="token punctuation">]</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="실행-및-ui-확인" tabindex="-1"><a class="header-anchor" href="#실행-및-ui-확인"><span>실행 및 UI 확인</span></a></h2><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ systemctl start nomad
$ systemctl <span class="token builtin class-name">enable</span> nomad
</code></pre></div><ul><li>UI 기본 포트 : 4646</li><li>http://&lt;server_ip&gt;:4646</li></ul><h2 id="job-실행" tabindex="-1"><a class="header-anchor" href="#job-실행"><span>Job 실행</span></a></h2><p>Job 실행은 CLI, API, UI 실행 가능</p><h3 id="cli" tabindex="-1"><a class="header-anchor" href="#cli"><span>CLI</span></a></h3><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token assign-left variable">NOMAD_ADDR</span><span class="token operator">=</span>http://<span class="token operator">&lt;</span>server_ip<span class="token operator">&gt;</span>:4646
$ nomad job run <span class="token operator">&lt;</span>job_file_path<span class="token operator">&gt;</span>
</code></pre></div><h3 id="ui" tabindex="-1"><a class="header-anchor" href="#ui"><span>UI</span></a></h3><ul><li><code>http://&lt;server_ip&gt;:4646</code> 에 접속</li><li>왼쪽 메뉴의 <code>WORKLOAD/Jobs</code> 선택</li><li>우측의 <code>Run Job</code> 버튼 클릭</li><li>Job 내용 입력 후 <code>Plan</code>, <code>Apply</code></li></ul><h2 id="job-sample" tabindex="-1"><a class="header-anchor" href="#job-sample"><span>Job Sample</span></a></h2><h3 id="batch-basic" tabindex="-1"><a class="header-anchor" href="#batch-basic"><span>batch - basic</span></a></h3><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>job <span class="token string-literal"><span class="token string">&quot;batch&quot;</span></span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>driver</code>가 <code>raw_exec</code>이면 isolation 없이 스크립트를 실행하는 방식</li><li><code>template</code> 에서 작성하는 파일은 동적으로 생성되며 변수 조합도 가능</li><li><code>artifact</code>를 정의하여 중앙 저장소의 파일을 다운로드 받아 구성 가능</li><li>한번 정상 동작 후 Job은 종료됨(기록은 남으나 GC 후 최종적으로 삭제됨)</li></ul><h3 id="batch-periodic" tabindex="-1"><a class="header-anchor" href="#batch-periodic"><span>batch - periodic</span></a></h3><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>job <span class="token string-literal"><span class="token string">&quot;periodic&quot;</span></span> <span class="token punctuation">{</span>
  datacenters <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string-literal"><span class="token string">&quot;dc1&quot;</span></span><span class="token punctuation">]</span>
...
echo $(date) &gt;&gt; /tmp/periodic.txt
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p><code>periodic</code> 에서 cron 형태로 정의 가능</p></li><li><p><code>constraint</code>은 조건을 부여하는 옵션으로 attribute와 meta 정보를 활용 가능, 해당 예제에서는 hostname 기준으로 동작 타겟 호스트를 정의함</p><ul><li><p>attribute를 조건으로 주는 방법은 attribute값 앞에 <code>attr.</code> prefix를 추가</p></li><li><p>meta의 경우 meta로 선언된 키 앞에 <code>meta.</code> prefix를 추가</p></li><li><p>CLI로 확인하는 방법</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ nomad agent-info <span class="token operator">|</span> <span class="token function">grep</span> node_id
...
echo &#39;batch param {{ env &quot;NOMAD_META_PARAM&quot; }}&#39; &gt;&gt; /tmp/param.txt
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>parameterized</code> 항목에서 json형태의 payload, 또는 URL Param 형태를 입력 받아 동작 가능</li><li>요청시에만 동작</li></ul><h2 id="sysbatch" tabindex="-1"><a class="header-anchor" href="#sysbatch"><span>sysbatch</span></a></h2><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>job <span class="token string-literal"><span class="token string">&quot;install_docker&quot;</span></span> <span class="token punctuation">{</span>
  datacenters <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string-literal"><span class="token string">&quot;dc1&quot;</span></span><span class="token punctuation">]</span>
...
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>docker를 ubuntu에 일괄 설치하는 예제</li><li>sysbatch는 조건에 맞는 모든 host node에서 실행</li></ul><h2 id="system" tabindex="-1"><a class="header-anchor" href="#system"><span>system</span></a></h2><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>job <span class="token string-literal"><span class="token string">&quot;system&quot;</span></span> <span class="token punctuation">{</span>
  datacenters <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string-literal"><span class="token string">&quot;dc1&quot;</span></span><span class="token punctuation">]</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>system 타입은 모든 노드에서 실행하는 agent 같은 역할의 실행을 수행</li><li>예제에서는 docker 타입의 실행을 예로 <code>redis:6.2.6-alpine3.15</code>를 모든 노드에서 실행하도록 구성</li><li><code>group/network</code> 에서 사용할 network 조건을 정의 <ul><li>to : 대상의 포트 정보</li><li>static : 고정할 클라이언트에서의 포트 정보 (정의되어 있지 않으면 랜덤 부여)</li><li>사용할 포트 이름은 docker로 정의된 task의 config/ports 에서 맵핑하여 관리</li></ul></li></ul><h3 id="service" tabindex="-1"><a class="header-anchor" href="#service"><span>Service</span></a></h3><div class="language-ruby line-numbers-mode" data-ext="rb" data-title="rb"><pre class="language-ruby"><code>job <span class="token string-literal"><span class="token string">&quot;service&quot;</span></span> <span class="token punctuation">{</span>
  datacenters <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string-literal"><span class="token string">&quot;dc1&quot;</span></span><span class="token punctuation">]</span>
