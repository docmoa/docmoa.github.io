---
url: >-
  /02-PublicCloud/NCP/09-Terraform-Workshop/01-intro_to_terraform_on_ncp/02-z-lab_terraform_basic.md
...
* 실행 창을 열고( ![](https://icons.iconarchive.com/icons/bogo-d/project/16/OS-Windows-7-icon.png) + R) `sysdm.cpl ,3`을 입력하여 확인
* 고급 탭의 `환경변수(N)...` 클릭
