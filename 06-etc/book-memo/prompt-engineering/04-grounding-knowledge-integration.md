---
url: /06-etc/book-memo/prompt-engineering/04-grounding-knowledge-integration.md
...
* **타입**: 엣지는 관계 타입을 가짐 (예: married\_to, discovered, won)
