---
url: /01-Infrastructure/Quantum/Business/lesson01-introducingquantumcomputing.md
description: '이 글은 양자 비즈니스 기초에 대한 내용으로, 양자 컴퓨팅 소개에 대해 다룹니다.'
---
...
::: tip 계산 복잡도 클래스
Quantum computer (양자 컴퓨터)가 해결할 수 있는 문제 유형에 대한 자세한 내용은 [BQP (Bounded-error Quantum Polynomial time, 유계 오차 양자 다항 시간)](https://medium.com/qiskit/what-can-a-quantum-computer-actually-do-4daed0691f6b)에 대한 기사를 참조하세요. BQP는 quantum computer (양자 컴퓨터)가 쉽게 해결할 수 있는 문제 목록입니다.
:::
...
::: tip Quantum-Centric Supercomputing (양자 중심 슈퍼컴퓨팅)
...
::: tip Quantum Programming Framework (양자 프로그래밍 프레임워크)
...
2. Hackett, R. (2019, May 21). Business Bets on a Quantum Leap. *Fortune*.
3. Chuang, I. L., Gershenfeld, N., & Kubinec, M. (1998). Experimental implementation of fast quantum searching. *Physical Review Letters*, 80(15), 3408–3411.
4. Vandersypen, L. M. K., et al. (2001). Experimental realization of Shor's quantum factoring algorithm using nuclear magnetic resonance. *Nature*, 414, 883–887.
5. Quantum programming framework (양자 프로그래밍 프레임워크) 관련 자료
6. Quantum technology (양자 기술) 확장 roadmap (로드맵) 관련 자료
7. Quantum runtime (양자 런타임) 성능 향상 관련 자료
8. Quantum programming framework (양자 프로그래밍 프레임워크) 설계 관련 자료
9. 100-qubit (100큐비트) processor (프로세서) 장벽 돌파 관련 자료
10. Quantum runtime primitives (양자 런타임 프리미티브) 관련 자료
11. Quantum-centric supercomputing (양자 중심 슈퍼컴퓨팅) roadmap (로드맵) 관련 자료
12. 대규모 quantum processor (양자 프로세서) 관련 자료
13. Dynamic Circuits 관련 자료
14. Quantum runtime resilience (양자 런타임 복원력) 관련 자료

## 추가 학습 자료

* [What Can a Quantum Computer Actually Do?](https://medium.com/qiskit/what-can-a-quantum-computer-actually-do-4daed0691f6b) - Quantum computer (양자 컴퓨터)가 해결할 수 있는 문제에 대한 기사
