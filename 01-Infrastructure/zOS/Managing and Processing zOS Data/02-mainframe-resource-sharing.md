---
url: >-
  /01-Infrastructure/zOS/Managing and Processing zOS
  Data/02-mainframe-resource-sharing.md
description: >-
  이 글은 IBM Z 메인프레임에서 여러 시스템이 리소스를 공유하는 방법에 대한 내용으로, PR/SM, LPAR, z/VM, 그리고 z/OS
  시스템 간 리소스 공유에 대해 다룹니다.
---
