---
url: /05-Software/Tomcat/tomcat101/10-monitoring.md
description: Tomcat
---
# 10. Tomcat 모니터링
...
* 아파치 버전, mod\_jk 버전, uptime, jkstatus 뷰 타입
* 각 워커의 설정 값
* 워커에서 수행중인 요청
* 워커에 맵핑된 정보
* 항목 설명
...
visualVM은 톰캣만이 아닌 JVM 전반에 대해 모니터링을 제공하는 툴로서 제공됩니다. Oracle JDK 1.6.0\_18 버전 이상부터는 기본으로 포함되어 있고 별도의 다운로드를 위해서는 관련 공식 페이지인 'http://visualvm.java.net'을 통해 받을 수 있습니다.
...
JDK 7 이상의 버전에서 "$JAVA\_HOME/bin/jmc"로 실행시키며, 수행된 툴은 다음과 같은 모습을 갖고 있습니다.
