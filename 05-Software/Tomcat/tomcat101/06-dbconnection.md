---
url: /05-Software/Tomcat/tomcat101/06-dbconnection.md
description: Tomcat
---
...
* lib 디렉토리에 복사
  * $CATALINA\_HOME/common/lib/jdbc.jar (5.5)
  * $CATALINA\_HOME/shared/lib/jdbc.jar (5.5)
  * $CATALINA\_HOME/lib/jdbc.jar (6+)
